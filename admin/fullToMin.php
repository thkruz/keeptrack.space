...
$GLOBALS['TLE_Min_File'] = '/var/www/html/admin/TLE/TLE.min.json';
$serverTime = time();
//$progress = 0;
...
if (filesize($GLOBALS['TLE_Temp_File']) > 148576) { //if TEMP TLE > 0.1MB
  ...
  if (!copy($GLOBALS['TLE_Temp_File'], $GLOBALS['TLE_Min_File'])) {
  ...
  echo "Filesize: " . filesize($GLOBALS['TLE_Temp_File']) / 1000 / 1000 . "MB\n\n";
  if (!copy($GLOBALS['TLE_Min_File'], $GLOBALS['TLE_Temp_File'])) {

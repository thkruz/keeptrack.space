function CanvasRecorder(e, o) {
    (this.start = function () {
        new Promise(function (e, o) {
            ...
            e(
                'https:' === window.location.protocol
                    ? 'getDisplayMedia' in navigator
                        ? navigator.getDisplayMedia(t).catch((e) => null)
            ...
            let l = { mimeType: d, videoBitsPerSecond: o || 1e7 };
            t = [];
            try {
                i = new MediaRecorder(r, l);
            } catch (e) {
                return (
                    (isVideoRecording = !1),
                    void $('#menu-record').removeClass('bmenu-item-selected')
                );
            }
            (i.onstop = c), (i.ondataavailable = a), i.start(100);
        });
    }),
        (this.stop = function () {
            i.stop(), (n.controls = !0);

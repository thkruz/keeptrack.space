...
;(function (global, factory) {
    ...
    _createClass(Animator, [
      ...
      },
      {
        ...
        value: function add(chart, items) {
          ...
          ;(_this$_getAnims$items = this._getAnims(chart).items).push.apply(
          ...
          for (i = props.length - 1; i >= 0; --i) {
            ...
            if (prop === 'options') {
              animations.push.apply(
                animations,
                _toConsumableArray(this._animateOptions(target, values)),
              )
              continue
            }
    ...
    _createClass(DatasetController, [
      ...
      },
      {
        ...
        value: function buildOrUpdateElements() {
          ...
          me._resyncElements(
            dataChanged || labelsChanged || scaleChanged || stackChanged,
          )
          if (stackChanged) {
          ...
          for (i = 0, ilen = count; i < ilen; ++i) {
            ...
            parsed[i] =
              ...
              _defineProperty(
                _parsed$i,
                iAxis,
                singleScale || iScale.parse(labels[index], index),
              ),
              _defineProperty(
                _parsed$i,
                vAxis,
      ...
      },
      {
        ...
        value: function getMinMax(scale, canStack) {
          ...
          function _skip() {
            ...
            return (
              isNaN(value) || otherMin > otherValue || otherMax < otherValue
            )
          }
          for (i = 0; i < ilen; ++i) {
            if (_skip()) {
        ...
        value: function _insertElements(start, count) {
          ...
          if (me._parsing) {
            ...
            ;(_meta$_parsed = meta._parsed).splice.apply(
              _meta$_parsed,
              [start, 0].concat(_toConsumableArray(new Array(count))),
            )
          }
  ...
  var DoughnutController = (function (_DatasetController) {
    ...
    function DoughnutController(chart, datasetIndex) {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(DoughnutController).call(this, chart, datasetIndex),
      )
      _this.innerRadius = undefined
      _this.outerRadius = undefined
    ...
    _createClass(DoughnutController, [
      ...
      },
      {
        ...
        value: function update(mode) {
          ...
          var maxWidth =
            (chartArea.right - chartArea.left - borderWidth) / ratioX
          var maxHeight =
            (chartArea.bottom - chartArea.top - borderWidth) / ratioY
  ...
  var PolarAreaController = (function (_DatasetController) {
    ...
    function PolarAreaController(chart, datasetIndex) {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(PolarAreaController).call(this, chart, datasetIndex),
      )
      _this.innerRadius = undefined
      _this.outerRadius = undefined
      return _this
      ...
      },
      {
        ...
        value: function resize(silent, width, height) {
          ...
          var newHeight = Math.max(
            0,
            Math.floor(aspectRatio ? newWidth / aspectRatio : height),
          )
      ...
      },
      {
        ...
        value: function _drawDataset(meta) {
          ...
          helpers.canvas.clipArea(ctx, {
            ...
            bottom:
              clip.bottom === false ? me.height : area.bottom + clip.bottom,
          })
        ...
        value: function calculateLabelRotation() {
          ...
          if (maxLabelWidth + 6 > tickWidth) {
            ...
            labelRotation = toDegrees(
              Math.min(
                Math.asin(
                  Math.min((labelSizes.highest.height + 6) / tickWidth, 1),
                ),
        ...
        value: function fit() {
          ...
          if (tickOpts.display && display) {
            ...
            if (isHorizontal) {
              ...
              var offsetRight =
                me.right - me.getPixelForTick(me.ticks.length - 1)
        ...
        value: function _computeGridLineItems(chartArea) {
          ...
          if (position === 'top') {
            ...
            if (position === 'center') {
              ...
              borderValue = alignBorderValue(
                me.chart.scales[_positionAxisID].getPixelForValue(_value),
              )
            }
            tx1 = borderValue - axisHalfWidth
            tx2 = tx1 - tl
      ...
      },
      {
        ...
        value: function drawGrid(chartArea) {
          ...
          if (axisWidth) {
            ...
            if (me.isHorizontal()) {
              x1 =
                _alignPixel(chart, me.left, firstLineWidth) - firstLineWidth / 2
              x2 =
                _alignPixel(chart, me.right, lastLineWidth) + lastLineWidth / 2
              y1 = y2 = borderValue
            } else {
              y1 =
                _alignPixel(chart, me.top, firstLineWidth) - firstLineWidth / 2
              y2 =
                _alignPixel(chart, me.bottom, lastLineWidth) + lastLineWidth / 2
              x1 = x2 = borderValue
            }
      ...
      },
      {
        ...
        value: function drawLabels(chartArea) {
          ...
          for (i = 0, ilen = items.length; i < ilen; ++i) {
            ...
            var useStroke =
              tickFont.lineWidth > 0 && tickFont.strokeStyle !== ''
            ctx.save()
        ...
        value: function fit() {
          ...
          if (isHorizontal) {
            ...
            me.legendItems.forEach(function (legendItem, i) {
              ...
              if (
                i > 0 &&
                currentColHeight + fontSize + 2 * vPadding > heightLimit
              ) {
          ...
          me.legendItems.forEach(function (legendItem, i) {
            ...
            if (isHorizontal) {
              if (
                ...
                x = cursor.x =
                  me.left +
                  alignmentOffset(legendWidth, lineWidths[cursor.line])
              }
    ...
    _createClass(Title, [
      ...
      },
      {
        ...
        value: function fit() {
          ...
          var textSize =
            lineCount * helpers.options._parseFont(opts).lineHeight +
            me._padding.height
    ...
    _createClass(Tooltip, [
      ...
      },
      {
        ...
        value: function _drawColorBox(ctx, pt, i, rtlHelper) {
          ...
          var yOffSet =
            boxHeight < bodyFontSize ? (bodyFontSize - boxHeight) / 2 : 0

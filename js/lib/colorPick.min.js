    ...
    (o.fn.colorPick = function (e) {
        ...
        (o.colorPick = function (e, t) {
            (t = t || {}),
                ...
                t.str &&
                    (this.options.str = o.extend(
                        {},
                        o.fn.colorPick.defaults.str,
                        t.str
                    )),
            ...
            return (
                ...
                (this.palette = l),
                this.element.hasClass(this.options.pickrclass)
                    ? this
                    : this.init()
            );
        }),
                        ...
                        .on('click', function (t) {
                            return (
                                ...
                                o('.colorPickButton').on('click', function (t) {
                                    return (
                                        (e.color = o(t.target).attr(
                                            'hexValue'
                                        )),
                                        e.appendToStorage(
                                            o(t.target).attr('hexValue')
                                        ),
                                        e.hide(),

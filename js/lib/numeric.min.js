...
'undefined' != typeof global && (global.numeric = numeric),
        ...
        return (
            (function r(e) {
                ...
                if ('number' == typeof e) {
                    ...
                    return (
                        n.push(
                            Array(numeric.precision + 8 - t.length).join(' ') +
                                t
                        ),
                        !1
                    );
    ...
    (numeric.parseDate = function (r) {
        return (function r(n) {
            ...
            if (!(n instanceof Array))
                throw new Error(
                    'parseDate: parameter must be arrays of strings'
                );
            var e,
                i = [];
    ...
    (numeric.Tbinop = function (r, n, e, i, t) {
        var u;
        if ((numeric.indexOf, 'string' != typeof t))
            for (u in ((t = ''), numeric))
    ...
    (numeric.T.prototype.set = function (r, n) {
        ...
        if (t) {
            ...
            return (
                (i[(e = r[u])] = c),
                (t[e] =
                    c instanceof Array ? numeric.rep(numeric.dim(c), 0) : 0),
                this
            );
        }
    ...
    (numeric.T.prototype.setRows = function (r, n, e) {
        ...
        if (c)
            for (
                u || ((u = numeric.rep(numeric.dim(t), 0)), (this.y = u)),
                    i = r;
                i <= n;
                i++
            )
        ...
        for (x = 0; x < n; x++) {
            for (d = 0; d < b - 1; d++)
                if (
                    ...
                    for (p = numeric.dot(k.Q, l), g = 0; g <= d; g++)
                        w[g] = p[g];
                ...
                for (v = d; v <= d + 1; v++)
                    if (
                        ...
                        for (
                            ...
                            l[g] = w[g];
                        for (p = numeric.dot(k.Q, l), g = 0; g <= v; g++)
                            w[g] = p[g];
    ...
    (numeric.T.prototype.fft = function () {
        var r,
            ...
            p = numeric.rep([a], 0),
            y = numeric.rep([a], 0);
        for (Math.floor(t / 2), r = 0; r < t; r++) p[r] = e[r];
    ...
    (numeric.dopri = function (r, n, e, i, t, u, o) {
        ...
        for ('function' == typeof o && (d = o(r, e)); r < n && N < u; )
            if (
                ...
                (a = i(
                    r + P[1] * L,
                    O(O(e, U(A[0] * L, M[F])), U(A[1] * L, c))
                )),
                (f = i(
                    r + P[2] * L,
                    O(
                        O(O(e, U(T[0] * L, M[F])), U(T[1] * L, c)),
                        U(T[2] * L, a)
                    )
                )),
                (m = i(
    ...
    (function (r) {
        ...
        numeric.solveQP = function (r, i, t, u, o, c) {
            (r = n(r)), (i = n(i)), (t = n(t));
            var a,
                f,
                m,
            ...
            if (
                ...
                for (a = 1; a <= m; a += 1) u[a] = 0;
            for (a = 1; a <= m; a += 1) p[a] = 0;
            for (s = Math.min(f, m), a = 1; a <= f; a += 1) y[a] = 0;
            for (
                l[1] = 0, a = 1;
                a <= 2 * f + (s * (s + 5)) / 2 + 2 * m + 1;
                a += 1
                ...
                g[a] = 0;
            for (a = 1; a <= 2; a += 1) d[a] = 0;
            return (
                (function (r, n, e, i, t, u, o, c, a, f, m, s, h, l, p, y) {
                    var g,
                        d,
                        v,
                        x,
                ...
                })(r, i, 0, f, y, l, t, u, 0, m, o, p, 0, d, g, c),
                (h = ''),
                1 === c[1] &&
                    (h = 'constraints are inconsistent, no solution!'),
                2 === c[1] &&
                    (h =

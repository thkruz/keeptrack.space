...
'undefined' != typeof global && (global.numeric = numeric),
    ...
    return (
      (function r(e) {
        ...
        if ('number' == typeof e) {
          ...
          return (
            n.push(Array(numeric.precision + 8 - t.length).join(' ') + t), !1
          )
        }
        ...
        if (e instanceof Array) {
          ...
          for (a = !1, n.push('['), i = 0; i < e.length; i++)
            i > 0 && (n.push(','), a && n.push('\n ')), (a = r(e[i]))
          return n.push(']'), !0
        }
        n.push('{')
          ...
          (i =
            (i +
              (e =
                (e +
                  (o =
                    (o = r[t][a][f]) > 255 ? 255 : o < 0 ? 0 : Math.round(o))) %
                65521)) %
            65521),
            p.push(o)
      p.push(0)
  ...
  (numeric.pointwise = function (r, n, e) {
    ...
    for (i = 0; i < r.length; i++)
      o.test(r[i]) ? (c = t = r[i].substring(0, r[i].length - 3)) : (t = r[i]),
        'ret' === t && (a = !0),
        u.push(t)
    return (
      (u[r.length] = '_s'),
  ...
  (numeric.blockMatrix = function (r) {
    ...
    for (t = 0; t < c; ++t) {
      for (m = i, u = a - 1; -1 !== u; --u)
        for (m -= (o = r[t][u])[0].length, h = o.length - 1; -1 !== h; --h)
  ...
  (numeric.T.prototype.inv = function () {
    ...
    for (f = 0; f < x; f++) {
      for (
        ...
        (l = (p = M[m][f]) * p + (y = k[m][f]) * y) > h && ((s = m), (h = l))
      for (
        s !== f &&
          ((v = M[f]),
          (M[f] = M[s]),
      ...
      for (m = f + 1; m < x; m++) {
        for (
          i = M[m], t = k[m], c = b[m], a = w[m], p = i[f], y = t[f], s = f + 1;
          s < x;
          s++
        )
          (g = n[s]),
  ...
  (numeric.QRFrancis = function (r, n) {
    ...
    for (x = 0; x < n; x++) {
      ...
      for (
        l = [w[0], w[1], w[2]], p = numeric.tensor(i, numeric.dot(i, l)), g = 0;
        g < 3;
        g++
      )
      ...
      for (d = 0; d < b - 2; d++) {
        for (v = d; v <= d + 1; v++)
          if (
            ...
            ;(k = numeric.QRFrancis(numeric.getBlock(r, [0, 0], [v, v]), n)),
              (A = numeric.QRFrancis(
        ...
        for (p = numeric.tensor(i, numeric.dot(i, l)), g = d + 1; g <= S; g++)
          for (s = w[g], y = p[g - d - 1], v = 0; v < b; v++) s[v] -= 2 * y[v]
      }
    }
    throw new Error(
        ...
        for (i = u - 1; i >= 0; i--) {
          ...
          numeric.neq(V.x, P.x) || numeric.neq(V.y, P.y)
            ? ((h = S.getRow(i).getBlock([i], [u - 1])),
              ...
              _.set([u, i], S.get([i, u]).neg().sub(h.dot(l)).div(V.sub(P))))
  ...
  (numeric.ccsSparse = function (r) {
    ...
    for (e = t - 1; -1 !== e; --e)
      for (i in (n = r[e]))
        0 !== n[i] && (u[i]--, (a[c[i] + u[i]] = e), (f[c[i] + u[i]] = n[i]))
    return [c, a, f]
  }),
  ...
  (numeric.ccsDot = function (r, n) {
    ...
    for (t = 0; t !== M; ++t) {
      for (u = g[t], o = g[t + 1], m = 0, i = u; i < o; ++i)
        for (s = d[i], h = v[i], c = l[s], a = l[s + 1], e = c; e < a; ++e)
  ...
  (numeric.ccsLUPSolve = function (r, n) {
    var e = r.L,
      ...
      u = !1
    'object' != typeof t &&
      ((t = (n = [[0, n.length], numeric.linspace(0, n.length - 1), n])[0]),
      (u = !0))
    var o,
      c,
      a,
    ...
    for (o = 0; o < y; ++o) {
      ...
      for (x.length = m, k(e, v, g, x, d), c = x.length - 1; -1 !== c; --c)
        v[x[c]] = 0
  ...
  (numeric.uncmin = function (r, n, e, i, t, u, o) {
    ...
    for (y = i(n); N < t; ) {
      ...
      for (
        ...
        N < t &&
        !(M * k < e) &&
        ((v = S(n, (d = P(p, M)))), (a = r(v)) - s >= 0.1 * M * f || isNaN(a));
  ...
  (numeric.__solveLP = function (r, n, e, i, t, u, o) {
    ...
    for (f = 0; f < t; ++f) {
      ...
      if (!T(j((P = l(e, p(n, (c = l(u, h(L, D)))))), 0)))
          ...
          switch (u) {
            ...
            case 3:
              h.hasOwnProperty(x[0]) ||
                ((h[x[0]] = l), (p[l] = 0), (y[l] = numeric.rep([s], 0)), ++l)
              var b = h[x[0]]
            ...
            case 4:
              for (e = 1; e < x.length; e += 2)
                g[f[x[e]]] = (m[f[x[e]]] < 0 ? -1 : 1) * parseFloat(x[e + 1])
              break
            case 5:
              break
            case 6:
  ...
  (function (r, n, e, i, t, u, o) {
    function c(r, n, e, i) {
      for (r += '', e = 0, i = 0; i < r.length; i++)
        n[a(i)] = a((e ^= 19 * n[a(i)]) + r.charCodeAt(i))
  ...
  (function (r) {
    ...
    function i(r, n, e, i, t, u, o, c, a, f, m, s, h, l, p, y) {
      ...
      if (((b = []), 0 === y[1])) {
        ...
        for (d = 1; d <= i; d += 1)
          for (t[d] = 0, g = 1; g <= d; g += 1) t[d] = t[d] + r[g][d] * n[g]
        for (d = 1; d <= i; d += 1)
          for (n[d] = 0, g = d; g <= i; g += 1) n[d] = n[d] + r[d][g] * t[g]
      }
      ...
      function Q() {
        ...
        for (d = h + 1; d <= i; d += 1)
          for (g = 1; g <= i; g += 1) p[x + g] = p[x + g] + r[g][d] * p[d]
        for (D = !0, g = h; g >= 1; g -= 1) {
          for (
        ...
        for (
          L = -p[T + S] / q, B = !0, D || (F < L && ((L = F), (B = !1))), g = 1;
          g <= i;
          g += 1
        )
      ...
      function Z() {
        ...
        return (
          (p[j + w] = p[j + w + 1]), (s[w] = s[w + 1]), (w += 1) < h ? 797 : 0
        )
      }
      function H() {
        return (
    ...
    numeric.solveQP = function (r, t, u, o, c, a) {
      ...
      for (p[1] = 0, f = 1; f <= 2 * m + (h * (h + 5)) / 2 + 2 * s + 1; f += 1)
        d[f] = 0
      ...
      return (
        ...
        2 === a[1] &&
          (l = 'matrix D in quadratic function is not positive definite!'),
        {
          solution: e(g),
          value: e(p),
      ...
      for (var k = 0; k < 50; k++) {
        ...
        if (!A) {
          ...
          for (
            ...
            for (
              v = y(g, (d = l[u])), l[u] = v, t = d / v, M = -g / v, o = 0;
              o < m;
              o++
            )
              (b = f[o][T]),

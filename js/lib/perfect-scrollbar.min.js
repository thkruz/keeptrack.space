      ...
      function (t, e, n) {
        ...
        l.initEvent('ps-scroll-up', !0, !0),
          ...
          (e.exports = function (t, e, n) {
            ...
            if ('top' === e && 0 >= n)
              return (t.scrollTop = 0), void t.dispatchEvent(h)
            if ('left' === e && 0 >= n)
              return (t.scrollLeft = 0), void t.dispatchEvent(p)
            var b = i.get(t)
            return 'top' === e && n >= b.contentHeight - b.containerHeight
              ? ((t.scrollTop = b.contentHeight - b.containerHeight),
                void t.dispatchEvent(v))
              : 'left' === e && n >= b.contentWidth - b.containerWidth
              ? ((t.scrollLeft = b.contentWidth - b.containerWidth),
                void t.dispatchEvent(f))
              : (r || (r = t.scrollTop),
                o || (o = t.scrollLeft),

    ...
    return function (satrec, tsince) {
      ...
      if (satrec.method === 'd') {
        ...
        if (Math.abs(cosip + 1.0) > 1.5e-12) {
          satrec.xlcof =
            (-0.25 * constants.j3oj2 * sinip * (3.0 + 5.0 * cosip)) /
            (1.0 + cosip)
        } else {
          satrec.xlcof =
            (-0.25 * constants.j3oj2 * sinip * (3.0 + 5.0 * cosip)) /
      ...
      if (irez !== 0) {
        ...
        if (irez === 2) {
          ...
          if (em < 0.7) {
            ...
            g533 =
              -37995.78 + 161616.52 * em - 229838.2 * emsq + 109377.94 * eoc
            g521 =
              -51752.104 + 218913.95 * em - 309468.16 * emsq + 146349.42 * eoc
            g532 =
              -40023.88 + 170470.89 * em - 242699.48 * emsq + 115605.82 * eoc
          }
          sini2 = sinim * sinim
    ...
    return function (satrec, sgp4initParameters) {
      ...
      if (omeosq >= 0.0 || satrec.no >= 0.0) {
        ...
        if (satrec.ecco > 1.0e-4) {
          cc3 =
            (-2.0 * coef * tsi * constants.j3oj2 * satrec.no * sinio) /
            satrec.ecco
        }
        ...
        if (Math.abs(cosio + 1.0) > 1.5e-12) {
          satrec.xlcof =
            (-0.25 * constants.j3oj2 * sinio * (3.0 + 5.0 * cosio)) /
            (1.0 + cosio)
        } else {
          satrec.xlcof =
            (-0.25 * constants.j3oj2 * sinio * (3.0 + 5.0 * cosio)) /

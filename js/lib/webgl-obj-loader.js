  ...
  \**********************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony reexport (safe) */ __webpack_require__.d(
            ...
            'Mesh',
            function () {
              return _mesh__WEBPACK_IMPORTED_MODULE_0__['default']
            },
          )
          ...
          /* harmony reexport (safe) */ __webpack_require__.d(
            ...
            'Material',
            function () {
              return _material__WEBPACK_IMPORTED_MODULE_1__['Material']
            },
          )
          ...
          /* harmony reexport (safe) */ __webpack_require__.d(
            ...
            'MaterialLibrary',
            function () {
              return _material__WEBPACK_IMPORTED_MODULE_1__['MaterialLibrary']
            },
          )
          ...
          /* harmony reexport (safe) */ __webpack_require__.d(
            ...
            'Attribute',
            function () {
              return _layout__WEBPACK_IMPORTED_MODULE_2__['Attribute']
            },
          )
          ...
          /* harmony reexport (safe) */ __webpack_require__.d(
            ...
            'Layout',
            function () {
              return _layout__WEBPACK_IMPORTED_MODULE_2__['Layout']
            },
          )
          ...
          /* harmony reexport (safe) */ __webpack_require__.d(
            ...
            'TYPES',
            function () {
              return _layout__WEBPACK_IMPORTED_MODULE_2__['TYPES']
            },
          )
          ...
          /* harmony reexport (safe) */ __webpack_require__.d(
            ...
            'downloadModels',
            function () {
              return _utils__WEBPACK_IMPORTED_MODULE_3__['downloadModels']
            },
          )
          ...
          /* harmony reexport (safe) */ __webpack_require__.d(
            ...
            'downloadMeshes',
            function () {
              return _utils__WEBPACK_IMPORTED_MODULE_3__['downloadMeshes']
            },
          )
          ...
          /* harmony reexport (safe) */ __webpack_require__.d(
            ...
            'initMeshBuffers',
            function () {
              return _utils__WEBPACK_IMPORTED_MODULE_3__['initMeshBuffers']
            },
          )
          ...
          /* harmony reexport (safe) */ __webpack_require__.d(
            ...
            'deleteMeshBuffers',
            function () {
              return _utils__WEBPACK_IMPORTED_MODULE_3__['deleteMeshBuffers']
            },
          )
          ...
          const OBJ = {
            ...
            MaterialLibrary:
              _material__WEBPACK_IMPORTED_MODULE_1__['MaterialLibrary'],
            Mesh: _mesh__WEBPACK_IMPORTED_MODULE_0__['default'],
            TYPES: _layout__WEBPACK_IMPORTED_MODULE_2__['TYPES'],
            downloadModels:
              _utils__WEBPACK_IMPORTED_MODULE_3__['downloadModels'],
            downloadMeshes:
              _utils__WEBPACK_IMPORTED_MODULE_3__['downloadMeshes'],
            initMeshBuffers:
              _utils__WEBPACK_IMPORTED_MODULE_3__['initMeshBuffers'],
            deleteMeshBuffers:
              _utils__WEBPACK_IMPORTED_MODULE_3__['deleteMeshBuffers'],
            version,
          }
          /**
           * @namespace
            ...
            constructor(...attributes) {
              ...
              for (const attribute of attributes) {
                ...
                if (offset % attribute.sizeOfType !== 0) {
                  offset +=
                    attribute.sizeOfType - (offset % attribute.sizeOfType)
                  console.warn(
       ...
       */
                  ...
                  for (const triangle of triangles) {
                    for (let j = 0, eleLen = triangle.length; j < eleLen; j++) {
                      ...
                      if (hash in unpacked.hashindices) {
                        unpacked.indices[currentObjectByMaterialIndex].push(
                        ...
                        if (textures.length) {
                          ...
                          unpacked.textures.push(
                            +textures[(+vertex[1] - 1) * stride + 0],
                          )
                          unpacked.textures.push(
                            +textures[(+vertex[1] - 1) * stride + 1],
                          )
                          if (options.enableWTextureCoord) {
                            unpacked.textures.push(
                              +textures[(+vertex[1] - 1) * stride + 2],
                            )
                          }
                        }
                        // Vertex normals
                        unpacked.norms.push(
                          +vertNormals[(+vertex[normalIndex] - 1) * 3 + 0],
                        )
                        unpacked.norms.push(
                          +vertNormals[(+vertex[normalIndex] - 1) * 3 + 1],
                        )
                        unpacked.norms.push(
                          +vertNormals[(+vertex[normalIndex] - 1) * 3 + 2],
                        )
            ...
            calculateTangentsAndBitangents() {
              ...
              for (let i = 0; i < indices.length; i += 3) {
                ...
                // Tangent
                const x_tangent =
                  (x_deltaPos1 * y_uvDeltaPos2 - x_deltaPos2 * y_uvDeltaPos1) *
                  r
                const y_tangent =
                  (y_deltaPos1 * y_uvDeltaPos2 - y_deltaPos2 * y_uvDeltaPos1) *
                  r
                const z_tangent =
                  (z_deltaPos1 * y_uvDeltaPos2 - z_deltaPos2 * y_uvDeltaPos1) *
                  r
                // Bitangent
                const x_bitangent =
                  (x_deltaPos2 * x_uvDeltaPos1 - x_deltaPos1 * x_uvDeltaPos2) *
                  r
                const y_bitangent =
                  (y_deltaPos2 * x_uvDeltaPos1 - y_deltaPos1 * x_uvDeltaPos2) *
                  r
                const z_bitangent =
                  (z_deltaPos2 * x_uvDeltaPos1 - z_deltaPos1 * x_uvDeltaPos2) *
                  r
                ...
                // Tangent
                const n0_dot_t =
                  x_tangent * x_n0 + y_tangent * y_n0 + z_tangent * z_n0
                const n1_dot_t =
                  x_tangent * x_n1 + y_tangent * y_n1 + z_tangent * z_n1
                const n2_dot_t =
                  x_tangent * x_n2 + y_tangent * y_n2 + z_tangent * z_n2
                ...
                // Bitangent
                const n0_dot_bt =
                  x_bitangent * x_n0 + y_bitangent * y_n0 + z_bitangent * z_n0
                const n1_dot_bt =
                  x_bitangent * x_n1 + y_bitangent * y_n1 + z_bitangent * z_n1
                const n2_dot_bt =
                  x_bitangent * x_n2 + y_bitangent * y_n2 + z_bitangent * z_n2
            ...
            makeBufferData(layout) {
              ...
              for (let i = 0, vertexOffset = 0; i < numItems; i++) {
                ...
                for (const attribute of layout.attributes) {
                  const offset =
                    vertexOffset + layout.attributeMap[attribute.key].offset
                  switch (attribute.key) {
                    case _layout__WEBPACK_IMPORTED_MODULE_0__['Layout'].POSITION
                      .key:
                    ...
                    case _layout__WEBPACK_IMPORTED_MODULE_0__['Layout'].UV.key:
                      ...
                      break
                    case _layout__WEBPACK_IMPORTED_MODULE_0__['Layout'].NORMAL
                      .key:
                      dataView.setFloat32(
                        offset,
                      ...
                      break
                    case _layout__WEBPACK_IMPORTED_MODULE_0__['Layout']
                      .MATERIAL_INDEX.key:
                      dataView.setInt16(
                        offset,
                      ...
                      break
                    case _layout__WEBPACK_IMPORTED_MODULE_0__['Layout'].AMBIENT
                      .key: {
                    ...
                    case _layout__WEBPACK_IMPORTED_MODULE_0__['Layout'].DIFFUSE
                      .key: {
                      const materialIndex = this.vertexMaterialIndices[i]
                      const material = this.materialsByIndex[materialIndex]
                      if (!material) {
                    ...
                    case _layout__WEBPACK_IMPORTED_MODULE_0__['Layout'].SPECULAR
                      .key: {
                      const materialIndex = this.vertexMaterialIndices[i]
                      const material = this.materialsByIndex[materialIndex]
                      if (!material) {
                    ...
                    case _layout__WEBPACK_IMPORTED_MODULE_0__['Layout'].EMISSIVE
                      .key: {
                      const materialIndex = this.vertexMaterialIndices[i]
                      const material = this.materialsByIndex[materialIndex]
                      if (!material) {
                    ...
                    case _layout__WEBPACK_IMPORTED_MODULE_0__['Layout'].DISSOLVE
                      .key: {
                      const materialIndex = this.vertexMaterialIndices[i]
                      const material = this.materialsByIndex[materialIndex]
                      if (!material) {
          ...
          function downloadModels(models) {
            ...
            for (const model of models) {
              ...
              const meshPromise = fetch(model.obj)
                ...
                .then((data) => {
                  return new _mesh__WEBPACK_IMPORTED_MODULE_0__['default'](
                    data,
                    options,
                  )
                })
              ...
              completed.push(
                fetch(url)
                  ...
                  .then((data) => {
                    return [
                      mesh_name,
                      new _mesh__WEBPACK_IMPORTED_MODULE_0__['default'](data),
                    ]
                  }),
              )
            }

    ...
    earth.init = function () {
      ...
      // Day Color Texture
      {
        ...
        if (settingsManager.nasaImages)
          img.src =
            settingsManager.installDirectory + 'textures/mercator-tex.jpg'
        if (settingsManager.trusatImages)
          img.src =
            settingsManager.installDirectory + 'textures/trusatvector-4096.jpg'
        if (settingsManager.blueImages)
          img.src =
            settingsManager.installDirectory + 'textures/world_blue-2048.png'
        if (settingsManager.lowresImages)
          img.src = settingsManager.installDirectory + 'textures/earthmap4k.jpg'
        ...
        if (
          ...
          if (settingsManager.hiresImages)
            imgHiRes.src =
              settingsManager.installDirectory + 'textures/earthmap8k.jpg'
      ...
      // Night Color Texture
      {
        ...
        nightImg.src =
          settingsManager.installDirectory + 'textures/earthlights4k.jpg'
        if (settingsManager.vectorImages)
          nightImg.src =
            settingsManager.installDirectory +
            'textures/dayearthvector-4096.jpg'
        ...
        if (
          ...
          nightImgHiRes.src =
            settingsManager.installDirectory + 'textures/earthlights10k.jpg'
      ...
      // Bump Map
      {
        ...
        earth.bumpMap.img.src =
          settingsManager.installDirectory + 'textures/earthbump8k.jpg'
      }
      ...
      // Specular Map
      {
        ...
        earth.specularMap.img.src =
          settingsManager.installDirectory + 'textures/earthspec8k.jpg'
      }
          ...
          if (timeManager.propRate > 1.01 || timeManager.propRate < 0.99) {
            if (timeManager.propRate < 10)
              earth.propRateDOM.html(
                'Propagation Speed: ' + timeManager.propRate.toFixed(1) + 'x',
              )
            if (timeManager.propRate >= 10)
              earth.propRateDOM.html(
                'Propagation Speed: ' + timeManager.propRate.toFixed(2) + 'x',
              )
  ...
  ;(function () {
    ...
    atmosphere.init = function () {
      ...
      for (let lat = 0; lat <= atmosphere.latSegs; lat++) {
        let latAngle = (Math.PI / atmosphere.latSegs) * lat - Math.PI / 2
  ...
  ;(function () {
    ...
    sun.getDirection = function (jd) {
      ...
      earth.lightDirection[1] =
        Math.cos(sun.sunvar.ob * DEG2RAD) * Math.sin(sun.sunvar.ecLon * DEG2RAD)
      earth.lightDirection[2] =
        Math.sin(sun.sunvar.ob * DEG2RAD) * Math.sin(sun.sunvar.ecLon * DEG2RAD)

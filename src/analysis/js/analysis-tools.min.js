...
(satellite.lookanglesInterval = 60),
  (satellite.calculateLookAngles = function (e, a, o, r) {
    ...
    !(function () {
      if (void 0 === a) {
        if (!satellite.sensorSelected()) return void console.debug('getlookangles2 requires a sensor!');
        a = satellite.currentSensor;
      } else {
        if (void 0 === a.obsminaz) return void console.debug('sensor format incorrect');
        a.observerGd = { lat: a.lat * DEG2RAD, lon: a.lon * DEG2RAD, height: 1 * a.alt };
      }
      void 0 === e ? console.debug('sat parameter required!') : (void 0 !== e.TLE1 && void 0 !== e.TLE2) || console.debug('sat parameter invalid format!'),
        void 0 === t && (t = 0),
        void 0 === o && (o = 1),
    ...
    function m(e, r) {
      ...
      if (
        ...
        if (satellite.isRiseSetLookangles) {
          ...
          var h = jday(D.getUTCFullYear(), D.getUTCMonth() + 1, D.getUTCDate(), D.getUTCHours(), D.getUTCMinutes(), D.getUTCSeconds());

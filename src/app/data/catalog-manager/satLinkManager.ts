...
export class SatLinkManager {
  ...
  private readonly wgsSatnums_: number[] = [32258, 34713, 36108, 38070, 39168, 39222, 40746, 41879, 42075, 44071];
  private readonly iridiumSatnums_: number[] = [
  ...
  private readonly galileoSatnums_: number[] = [

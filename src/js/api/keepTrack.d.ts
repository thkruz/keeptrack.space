...
export interface DotsManager {
  ...
  draw(mainCamera: Camera, currentColorScheme: ColorScheme, curBuffer: WebGLBuffer): void;
  drawGpuPickingFrameBuffer(mainCamera: Camera, currentColorScheme: ColorScheme): void;

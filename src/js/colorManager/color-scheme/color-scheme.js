class ColorScheme {
  ...
  // Private References to the Major Components Passed from the Color Scheme Factory (ColorScheme)
  #gl;
  #hoverSat;
  #selectSat;

  // Private Variables that will get reused a lot during the draw loop
  #now;
  #lastCalculation = 0;
  #colorData;
  #pickableData;

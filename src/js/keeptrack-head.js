...
// Settings Manager Setup
{
    ...
    if ((/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/ui).test(navigator.userAgent)) {
...
let db = {};
{
    ...
    db.init = (function () {
        ...
        if (db.enabled) {
            ...
            try {
                if (sensorManager.currentSensor.length > 1) sensorManager.currentSensor = sensorManager.currentSensor[0];
            } catch {
              // Intentionally Empty
            }
        }

...
export { ZOOM_EXP, TAU, DEG2RAD, RAD2DEG, RADIUS_OF_EARTH, MILLISECONDS_PER_DAY, RADIUS_OF_SUN, MINUTES_PER_DAY, PLANETARIUM_DIST, SUN_SCALAR_DISTANCE, RADIUS_OF_DRAW_SUN, RADIUS_OF_DRAW_MOON, MOON_SCALAR_DISTANCE };

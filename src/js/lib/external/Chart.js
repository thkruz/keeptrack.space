...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? (module.exports = factory()) : typeof define === 'function' && define.amd ? define(factory) : ((global = global || self), (global.Chart = factory()));
})(this, function () {
  'use strict';
  ...
  function inherits(extensions) {
    var me = this;
    var ChartElement =
      extensions && Object.prototype.hasOwnProperty.call(extensions, 'constructor')
  ...
  var Chart = (function () {
    function Chart(item, config) {
      ...
      if (!context || !canvas) {
        console.debug("Failed to create chart: can't acquire context from the given item");
        return;
      }

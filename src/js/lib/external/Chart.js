...
(function (global, factory) {
    ...
    function valueAtIndexOrDefault(value, index, defaultValue) {
        return valueOrDefault(
            isArray(value) ? value[index] : value,
            defaultValue
        );
    }
    ...
    function inherits(extensions) {
        ...
        var ChartElement =
            extensions &&
            Object.prototype.hasOwnProperty.call(extensions, 'constructor')
    ...
    function getRelativePosition(evt, chart) {
        ...
        var paddingBottom = parseFloat(
            getStyle(canvasElement, 'padding-bottom')
        );
        var width =
    ...
    function getMaximumWidth(domNode) {
        ...
        var paddingLeft = _calculatePadding(
            container,
            'padding-left',
            clientWidth
        );
        var paddingRight = _calculatePadding(
            container,
            'padding-right',
            clientWidth
        );
    ...
    function getMaximumHeight(domNode) {
        ...
        var paddingTop = _calculatePadding(
            container,
            'padding-top',
            clientHeight
        );
        var paddingBottom = _calculatePadding(
            container,
            'padding-bottom',
            clientHeight
        );
    ...
    function _parseFont(options) {
        ...
        var font = {
            ...
            lineHeight: toLineHeight(
                valueOrDefault(options.lineHeight, defaults.lineHeight),
                size
            ),
            size: size,
        ...
        return (
            ...
            (v.a < 255
                ? 'rgba('
                      ...
                      .concat(v.b, ', ')
                      .concat(b2n(v.a), ')')
                : 'rgb('.concat(v.r, ', ').concat(v.g, ', ').concat(v.b, ')'))
        );
    }
    ...
    function getHoverColor(value) {
        return isPatternOrGradient(value)
            ? value
            : index(value).saturate(0.5).darken(0.1).hexString();
    }
        ...
        _createClass(Animator, [
            ...
            },
            {
                ...
                value: function _refresh() {
                    ...
                    me._running = true;
                    me._request = helpers.requestAnimFrame.call(
                        window,
                        function () {
                            me._update();
                            me._request = null;
            ...
            },
            {
                ...
                value: function add(chart, items) {
                    ...
                    (_this$_getAnims$items = this._getAnims(chart)
                        .items).push.apply(
                        _this$_getAnims$items,
                    ...
                    Object.keys(animations).forEach(function (key) {
                        ...
                        (cfg.properties || [key]).forEach(function (prop) {
                            if (!animatedProps.has(prop)) {
                                animatedProps.set(
                                    prop,
                                    _extends({}, animDefaults, cfg)
                                );
                            } else if (prop === key) {
                                animatedProps.set(
                                    prop,
                                    _extends({}, animatedProps.get(prop), cfg)
                                );
                            }
                        });
                    });
            ...
            },
            {
                ...
                value: function _animateOptions(target, values) {
                    ...
                    if (options) {
                        ...
                        animations = this._createAnimations(
                            options,
                            newOptions
                        );
                    } else {
                    ...
                    for (i = props.length - 1; i >= 0; --i) {
                        ...
                        if (prop === 'options') {
                            animations.push.apply(
                                animations,
                                _toConsumableArray(
                                    this._animateOptions(target, values)
                                )
                            );
                            continue;
                        }
    ...
    function _applyStack(stack, value, dsIndex, allOther) {
        ...
        for (i = 0, ilen = keys.length; i < ilen; ++i) {
            ...
            if (
                !isNaN(otherValue) &&
                (value === 0 ||
                    helpers.math.sign(value) === helpers.math.sign(otherValue))
            ) {
                value += otherValue;
            }
        }
        ...
        _createClass(DatasetController, [
            ...
            },
            {
                ...
                value: function linkScales() {
                    ...
                    var xid = (meta.xAxisID =
                        dataset.xAxisID || getFirstScaleId(chart, 'x'));
                    var yid = (meta.yAxisID =
                        dataset.yAxisID || getFirstScaleId(chart, 'y'));
                    var rid = (meta.rAxisID =
                        dataset.rAxisID || getFirstScaleId(chart, 'r'));
            ...
            },
            {
                ...
                value: function _dataCheck() {
                    ...
                    if (helpers.isObject(data)) {
                        ...
                        if (
                            me._data === data &&
                            helpers.arrayEquals(data, me._dataCopy)
                        ) {
                            return false;
                        }
                        if (me._data) {
            ...
            },
            {
                ...
                value: function configure() {
                    ...
                    me._parsing = resolve$1([
                        me._config.parsing,
                        me.chart.options.parsing,
                        true,
                    ]);
                },
            },
                    ...
                    for (i = 0, ilen = count; i < ilen; ++i) {
                        ...
                        parsed[i] =
                            ...
                            _defineProperty(
                                ...
                                iAxis,
                                singleScale ||
                                    iScale.parse(labels[index], index)
                            ),
                            _defineProperty(
                                _parsed$i,
                                vAxis,
                                vScale.parse(data[index], index)
                            ),
                            _parsed$i);
                    }
                    return parsed;
            ...
            },
            {
                ...
                value: function _addAutomaticHoverColors(index, options) {
                    ...
                    var missingColors = Object.keys(normalOptions).filter(
                        function (key) {
                            return (
                                key.indexOf('Color') !== -1 && !(key in options)
                            );
                        }
                    );
            ...
            },
            {
                ...
                value: function resolveDatasetElementOptions(active) {
                    ...
                    var options =
                        chart.options.elements[me.datasetElementType._type] ||
                        {};
            ...
            },
            {
                ...
                value: function resolveDataElementOptions(index, mode) {
                    ...
                    var datasetOpts = me._config;
                    var options =
                        chart.options.elements[me.dataElementType._type] || {};
                    ...
                    if (helpers.isArray(elementOptions)) {
                        for (
                            i = 0, ilen = elementOptions.length;
                            i < ilen;
                            ++i
                        ) {
                            key = elementOptions[i];
            ...
            },
            {
                ...
                value: function _resolveAnimations(index, mode, active) {
                    ...
                    var context = me._getContext(index, active);
                    var datasetAnim = resolve$1(
                        [me._config.animation],
                        context,
                        index,
                        info
                    );
                    var chartAnim = resolve$1(
            ...
            },
            {
                ...
                value: function updateElement(
                    ...
                    if (mode === 'reset' || mode === 'none') {
                        ...
                        this._resolveAnimations(index, mode).update(
                            element,
                            properties
                        );
                    }
            ...
            },
            {
                ...
                value: function _setStyle(element, index, mode, active) {
                    ...
                    this._resolveAnimations(index, mode, active).update(
                        element,
                        {
            ...
            },
            {
                ...
                value: function _insertElements(start, count) {
                    ...
                    if (me._parsing) {
                        var _meta$_parsed;
                        (_meta$_parsed = meta._parsed).splice.apply(
                            _meta$_parsed,
                            [start, 0].concat(
                                _toConsumableArray(new Array(count))
                            )
                        );
                    }
        ...
        _createClass(Arc, [
            ...
            },
            {
                ...
                value: function draw(ctx) {
                    ...
                    var pixelMargin =
                        options.borderAlign === 'inner' ? 0.33 : 0;
                    var arc = {
                        x: me.x,
                        y: me.y,
                    ...
                    if (arc.fullCircles) {
                        ...
                        arc.endAngle =
                            arc.startAngle + (me.circumference % TAU$1);
                    }
                    ctx.beginPath();
                    ctx.arc(
                        arc.x,
    ...
    function _boundSegment(segment, points, bounds) {
        ...
        for (i = start; i <= end; ++i) {
            ...
            if (subStart === null && inside) {
                subStart =
                    i > start && compare(value, startBound) > 0 ? prev : i;
            }
            if (
                subStart !== null &&
                (!inside || compare(value, endBound) === 0)
            ) {
    ...
    var Line = (function (_Element) {
        ...
        function Line(cfg) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(Line).call(this)
            );
            _this.options = undefined;
        ...
        _createClass(Line, [
            ...
            },
            {
                ...
                get: function get() {
                    return (
                        this._segments ||
                        (this._segments = _computeSegments(this))
                    );
                },
            },
        ]);
    ...
    var Point = (function (_Element) {
        ...
        function Point(cfg) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(Point).call(this)
            );
            _this.options = undefined;
        ...
        _createClass(Point, [
            ...
            },
            {
                ...
                value: function inXRange(mouseX, useFinalPosition) {
                    ...
                    return (
                        Math.abs(mouseX - x) <
                        options.radius + options.hitRadius
                    );
                },
            },
            {
            ...
            },
            {
                ...
                value: function size() {
                    var options = this.options || {};
                    var radius =
                        Math.max(options.radius, options.hoverRadius) || 0;
    ...
    function getBarBounds(bar, useFinalPosition) {
        var _bar$getProps = bar.getProps(
    ...
    function _inRange(bar, x, y, useFinalPosition) {
        ...
        var bounds =
            !bar || (skipX && skipY)
                ? false
                : getBarBounds(bar, useFinalPosition);
        return (
            bounds &&
    ...
    var Rectangle = (function (_Element) {
        ...
        function Rectangle(cfg) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(Rectangle).call(this)
            );
            _this.options = undefined;
    ...
    var BarController = (function (_DatasetController) {
        ...
        function BarController() {
            ...
            return _possibleConstructorReturn(
                this,
                _getPrototypeOf(BarController).apply(this, arguments)
            );
        }
        _createClass(BarController, [
            ...
            },
            {
                ...
                value: function parseObjectData(meta, data, start, count) {
                    ...
                    for (i = start, ilen = start + count; i < ilen; ++i) {
                        obj = data[i];
                        item = {};
                        item[iScale.axis] = iScale.parseObject(
                            obj,
                            iScale.axis,
                            i
                        );
                        ...
                        if (isArray(value)) {
                            ...
                            item[vScale.axis] = vScale.parseObject(
                                obj,
                                vProp,
                                i
                            );
            ...
            },
            {
                ...
                value: function initialize() {
                    var me = this;
                    _get(
                        _getPrototypeOf(BarController.prototype),
                        'initialize',
                        this
                    ).call(this);
                    var meta = me._cachedMeta;
            ...
            },
            {
                ...
                value: function updateElements(rectangles, start, mode) {
                    ...
                    var sharedOptions = me.getSharedOptions(
                        mode,
                        rectangles[start],
                        firstOpts
                    );
                    ...
                    for (i = 0; i < rectangles.length; i++) {
                        ...
                        var vpixels = me._calculateBarValuePixels(
                            index,
                            options
                        );
                        var ipixels = me._calculateBarIndexPixels(
                            index,
                            ruler,
                            options
                        );
            ...
            },
            {
                ...
                value: function _calculateBarValuePixels(index, options) {
                    ...
                    var start = 0;
                    var length = meta._stacked
                        ? me.applyStack(vScale, parsed)
                        : value;
                    var head, size;
                    if (length !== value) {
                        start = length - value;
            ...
            },
            {
                ...
                value: function _calculateBarIndexPixels(
                    index,
                    ruler,
                    options
                ) {
                    ...
                    var stackIndex = me._getStackIndex(
                        me.index,
                        me._cachedMeta.stack
                    );
                    var center =
                        range.start +
                        range.chunk * stackIndex +
                        range.chunk / 2;
                    var size = Math.min(
    ...
    var BubbleController = (function (_DatasetController) {
        ...
        function BubbleController() {
            ...
            return _possibleConstructorReturn(
                this,
                _getPrototypeOf(BubbleController).apply(this, arguments)
            );
        }
        _createClass(BubbleController, [
            ...
            },
            {
                ...
                value: function resolveDataElementOptions(index, mode) {
                    ...
                    var parsed = me.getParsed(index);
                    var values = _get(
                        _getPrototypeOf(BubbleController.prototype),
                        'resolveDataElementOptions',
                        this
                    ).call(this, index, mode);
                    var context = {
                        chart: chart,
                        dataIndex: index,
                        dataset: dataset,
    ...
    var DoughnutController = (function (_DatasetController) {
        ...
        function DoughnutController(chart, datasetIndex) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(DoughnutController).call(
                    this,
                    chart,
                    datasetIndex
                )
        ...
        _createClass(DoughnutController, [
            ...
            },
            {
                ...
                value: function update(mode) {
                    ...
                    var _getRatioAndOffset = getRatioAndOffset(
                            options.rotation,
                    ...
                    var maxWidth =
                        (chartArea.right - chartArea.left - borderWidth) /
                        ratioX;
                    var maxHeight =
                        (chartArea.bottom - chartArea.top - borderWidth) /
                        ratioY;
                    ...
                    var radiusLength =
                        ...
                        me._getVisibleDatasetWeightTotal();
                    me.offsetX = offsetX * outerRadius;
                    me.offsetY = offsetY * outerRadius;
                    meta.total = me.calculateTotal();
                    me.outerRadius =
                        outerRadius -
                        radiusLength * me._getRingWeightOffset(me.index);
                    me.innerRadius = Math.max(
                        me.outerRadius - radiusLength * chartWeight,
                        0
                    );
                ...
                value: function _circumference(i, reset) {
                    ...
                    return reset && opts.animation.animateRotate
                        ...
                        ? me.calculateCircumference(
                              (meta._parsed[i] * opts.circumference) /
                                  DOUBLE_PI$1
                          )
                        : 0;
                },
    ...
    var HorizontalBarController = (function (_BarController) {
        ...
        function HorizontalBarController() {
            ...
            return _possibleConstructorReturn(
                this,
                _getPrototypeOf(HorizontalBarController).apply(this, arguments)
            );
        }
    ...
    var LineController = (function (_DatasetController) {
        ...
        function LineController(chart, datasetIndex) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(LineController).call(this, chart, datasetIndex)
            );
        ...
        _createClass(LineController, [
            {
                ...
                value: function update(mode) {
                    ...
                    var showLine = (me._showLine = valueOrDefault(
                        config.showLine,
                        options.showLines
                    ));
            ...
            },
            {
                ...
                value: function updateElements(points, start, mode) {
                    ...
                    var includeOptions = me.includeOptions(mode, sharedOptions);
                    var spanGaps = valueOrDefault(
                        me._config.spanGaps,
                        me.chart.options.spanGaps
                    );
                    var maxGapLength = isNumber(spanGaps)
                        ? spanGaps
                    ...
                    for (var i = 0; i < points.length; ++i) {
                        ...
                        var properties = {
                            ...
                            skip: isNaN(x) || isNaN(y),
                            stop:
                                i > 0 && parsed.x - prevParsed.x > maxGapLength,
                        };
                        if (includeOptions) {
                            properties.options = me.resolveDataElementOptions(
                                index,
            ...
            },
            {
                ...
                value: function resolveDatasetElementOptions(active) {
                    ...
                    var values = _get(
                        _getPrototypeOf(LineController.prototype),
            ...
            },
            {
                ...
                value: function getMaxOverflow() {
                    ...
                    var meta = me._cachedMeta;
                    var border =
                        (me._showLine && meta.dataset.options.borderWidth) || 0;
                    var data = meta.data || [];
                    if (!data.length) {
                        return border;
                    }
    ...
    var PolarAreaController = (function (_DatasetController) {
        ...
        function PolarAreaController(chart, datasetIndex) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(PolarAreaController).call(
                    this,
                    chart,
                    datasetIndex
                )
        ...
        _createClass(PolarAreaController, [
            ...
            },
            {
                ...
                value: function updateElements(arcs, start, mode) {
                    ...
                    var datasetStartAngle = getStartAngleRadians(
                        opts.startAngle
                    );
                    ...
                    for (i = 0; i < arcs.length; i++) {
                        ...
                        var outerRadius = this.chart.getDataVisibility(index)
                ...
                value: function countVisibleElements() {
                    ...
                    meta.data.forEach(function (element, index) {
                        if (
                            ...
                            _this2.chart.getDataVisibility(index)
                        ) {
                            count++;
                        }
                    });
    ...
    var RadarController = (function (_DatasetController) {
        ...
        function RadarController() {
            ...
            return _possibleConstructorReturn(
                this,
                _getPrototypeOf(RadarController).apply(this, arguments)
            );
        }
        _createClass(RadarController, [
            ...
            },
            {
                ...
                value: function resolveDatasetElementOptions(active) {
                    ...
                    var options = me.chart.options;
                    var values = _get(
                        _getPrototypeOf(RadarController.prototype),
                        'resolveDatasetElementOptions',
                        this
                    ).call(this, active);
                    values.spanGaps = valueOrDefault(
    ...
    function binarySearch(metaset, axis, value, intersect) {
        ...
        if (iScale && axis === iScale.axis && _sorted && data.length) {
            var lookupMethod = iScale._reversePixels
                ? _rlookupByKey
                : _lookupByKey;
            if (!intersect) {
    ...
    function getIntersectItems(chart, position, axis, useFinalPosition) {
        ...
        var evaluationFunc = function evaluationFunc(
            element,
            datasetIndex,
            index
        ) {
    ...
    var Interaction = {
        modes: {
            ...
            x: function x(chart, e, options, useFinalPosition) {
                ...
                evaluateAllVisibleItems(chart, function (
                    element,
                    datasetIndex,
                    index
                ) {
    ...
    function filterDynamicPositionByAxis(array, axis) {
        return array.filter(function (v) {
            return (
                STATIC_POSITIONS.indexOf(v.pos) === -1 && v.box.axis === axis
            );
        });
    }
    ...
    var BasicPlatform = (function (_BasePlatform) {
        ...
        function BasicPlatform() {
            ...
            return _possibleConstructorReturn(
                this,
                _getPrototypeOf(BasicPlatform).apply(this, arguments)
            );
        }
        _createClass(BasicPlatform, [
            {
                ...
                value: function acquireContext(item) {
                    return (
                        (item && item.getContext && item.getContext('2d')) ||
                        null
                    );
                },
            },
    ...
    var DomPlatform = (function (_BasePlatform) {
        ...
        function DomPlatform() {
            ...
            return _possibleConstructorReturn(
                this,
                _getPrototypeOf(DomPlatform).apply(this, arguments)
            );
        }
    ...
    function mergeScaleConfig(config, options) {
        ...
        Object.keys(configScales).forEach(function (id) {
            ...
            scales[id] = helpers.mergeIf({}, [
                configScales[id],
                chartDefaults.scales[axis],
            ]);
        });
        if (options.scale) {
            scales[options.scale.id || 'r'] = helpers.mergeIf({}, [
                options.scale,
    ...
    function positionIsHorizontal(position, axis) {
        return (
            position === 'top' ||
            position === 'bottom' ||
            (!KNOWN_POSITIONS.has(position) && axis === 'x')
        );
    }
        ...
        _createClass(Chart, [
            ...
            },
            {
                ...
                value: function resize(silent, width, height) {
                    ...
                    var aspectRatio =
                        options.maintainAspectRatio && me.aspectRatio;
                    ...
                    var newRatio =
                        ...
                        me.platform.getDevicePixelRatio();
                    if (
                        me.width === newWidth &&
                        me.height === newHeight &&
                        oldRatio === newRatio
            ...
            },
            {
                ...
                value: function buildOrUpdateScales() {
                    ...
                    if (scaleOpts) {
                        items = items.concat(
                            Object.keys(scaleOpts).map(function (axisID) {
                                ...
                                var isRadial =
                                    axisID.charAt(0).toLowerCase() === 'r';
                                var isHorizontal =
                                    axisID.charAt(0).toLowerCase() === 'x';
                                return {
                                    options: axisOptions,
                                    dposition: isRadial
                                        ? 'chartArea'
                    ...
                    helpers.each(items, function (item) {
                        ...
                        var scaleType = valueOrDefault$1(
                            scaleOptions.type,
                            item.dtype
                        );
                        if (
                        ...
                        scale.axis =
                            scale.options.position === 'chartArea'
                                ? 'r'
                                : scale.isHorizontal()
                                ? 'x'
                                : 'y';
                ...
                value: function _updateLayout() {
                    ...
                    helpers.each(
                        ...
                        function (box) {
                            ...
                            (_me$_layers = me._layers).push.apply(
                                _me$_layers,
                                _toConsumableArray(box._layers())
                            );
                        },
                        me
                    );
            ...
            },
            {
                ...
                value: function _updateDatasets(mode) {
                    ...
                    if (
                        pluginsCore.notify(me, 'beforeDatasetsUpdate') === false
                    ) {
                        return;
                    }
                    for (
            ...
            },
            {
                ...
                value: function _updateDataset(index, mode) {
                    ...
                    if (
                        pluginsCore.notify(me, 'beforeDatasetUpdate', [
                            args,
                        ]) === false
                    ) {
                        return;
            ...
            },
            {
                ...
                value: function _drawDatasets() {
                    var me = this;
                    if (
                        pluginsCore.notify(me, 'beforeDatasetsDraw') === false
                    ) {
                        return;
                    }
            ...
            },
            {
                ...
                value: function _drawDataset(meta) {
                    ...
                    if (
                        pluginsCore.notify(me, 'beforeDatasetDraw', [args]) ===
                        false
                    ) {
                        return;
                    }
            ...
            },
            {
                ...
                value: function getElementsAtEventForMode(
                    e,
                    mode,
                    options,
                    useFinalPosition
            ...
            },
            {
                ...
                value: function _updateDatasetVisibility(
                    datasetIndex,
                    visible
                ) {
                    var me = this;
                    ...
                    var anims = meta.controller._resolveAnimations(
                        undefined,
                        mode
                    );
                    ...
                    me.update(function (ctx) {
                        return ctx.datasetIndex === datasetIndex
                            ? mode
                            : undefined;
                    });
                },
            ...
            },
            {
                ...
                value: function toBase64Image() {
                    var _this$canvas;
                    return (_this$canvas = this.canvas).toDataURL.apply(
                        _this$canvas,
                        arguments
                    );
                },
            ...
            },
            {
                ...
                value: function _eventHandler(e, replay) {
                    var me = this;
                    if (
                        pluginsCore.notify(me, 'beforeEvent', [e, replay]) ===
                        false
                    ) {
                        return;
                    }
            ...
            },
            {
                ...
                value: function _handleEvent(e, replay) {
                    ...
                    if (e.type === 'mouseup' || e.type === 'click') {
                        if (
                            options.onClick &&
                            helpers.canvas._isPointInArea(e, me.chartArea)
                        ) {
    ...
    var Ticks = {
        formatters: {
            ...
            numeric: function numeric(tickValue, index, ticks) {
                ...
                var minTick = Math.min(
                    Math.abs(ticks[0].value),
                    Math.abs(ticks[ticks.length - 1].value)
                );
                var locale = this.chart.options.locale;
                if (maxTick < 1e-4 || minTick > 1e7) {
    ...
    var Scale = (function (_Element) {
        ...
        function Scale(cfg) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(Scale).call(this)
            );
            _this.id = cfg.id;
            _this.type = cfg.type;
        ...
        _createClass(Scale, [
            ...
            },
            {
                ...
                value: function fit() {
                    ...
                    var labelsBelowTicks =
                        opts.position !== 'top' && me.axis === 'x';
                    ...
                    if (tickOpts.display && display) {
                        ...
                        if (isHorizontal) {
                            ...
                            var offsetRight =
                                me.right -
                                me.getPixelForTick(me.ticks.length - 1);
                            ...
                            if (isRotated) {
                                ...
                                paddingRight = labelsBelowTicks
                                    ? sinRotation *
                                      (lastLabelSize.height -
                                          lastLabelSize.offset)
            ...
            },
            {
                ...
                value: function _handleMargins() {
                    var me = this;
                    if (me._margins) {
                        me._margins.left = Math.max(
                            me.paddingLeft,
                            me._margins.left
                        );
                        me._margins.top = Math.max(
                            me.paddingTop,
                            me._margins.top
                        );
                        me._margins.right = Math.max(
                            me.paddingRight,
                            me._margins.right
                        );
                        me._margins.bottom = Math.max(
                            me.paddingBottom,
                            me._margins.bottom
                        );
                    }
            ...
            },
            {
                ...
                value: function getPixelForTick(index) {
                    ...
                    var numTicks = me.ticks.length;
                    var tickWidth =
                        1 / Math.max(numTicks - (offset ? 0 : 1), 1);
            ...
            },
            {
                ...
                value: function _autoSkip(ticks) {
                    ...
                    var ticksLimit =
                        tickOpts.maxTicksLimit || axisLength / me._tickSize();
            ...
            },
            {
                ...
                value: function _tickSize() {
                    ...
                    var h = labelSizes
                        ? labelSizes.highest.height + padding
                        : 0;
            ...
            },
            {
                ...
                value: function _computeGridLineItems(chartArea) {
                    ...
                    var axisWidth = gridLines.drawBorder
                        ? resolve(
                              [gridLines.borderWidth, gridLines.lineWidth, 0],
                              context,
                              0
                          )
                        : 0;
            ...
            },
            {
                ...
                value: function drawGrid(chartArea) {
                    ...
                    var items =
                        me._gridLineItems ||
                        (me._gridLineItems = me._computeGridLineItems(
                            chartArea
                        ));
                    var i, ilen;
                    ...
                    if (axisWidth) {
                        ...
                        if (me.isHorizontal()) {
                            x1 =
                                _alignPixel(chart, me.left, firstLineWidth) -
                                firstLineWidth / 2;
                            x2 =
                                _alignPixel(chart, me.right, lastLineWidth) +
                                lastLineWidth / 2;
                            y1 = y2 = borderValue;
                        } else {
                            y1 =
                                _alignPixel(chart, me.top, firstLineWidth) -
                                firstLineWidth / 2;
                            y2 =
                                _alignPixel(chart, me.bottom, lastLineWidth) +
                                lastLineWidth / 2;
                            x1 = x2 = borderValue;
                        }
            ...
            },
            {
                ...
                value: function drawLabels(chartArea) {
                    ...
                    var items =
                        me._labelItems ||
                        (me._labelItems = me._computeLabelItems(chartArea));
                    var i, j, ilen, jlen;
                    for (i = 0, ilen = items.length; i < ilen; ++i) {
                        var item = items[i];
            ...
            },
            {
                ...
                value: function drawTitle(chartArea) {
                    ...
                    var scaleLabelFontColor = valueOrDefault(
                    ...
                    if (me.isHorizontal()) {
                        switch (scaleLabelAlign) {
                            case 'start':
                                scaleLabelX =
                                    me.left + (isReverse ? me.width : 0);
                                textAlign = isReverse ? 'right' : 'left';
                                break;
                            case 'end':
                                scaleLabelX =
                                    me.left + (isReverse ? 0 : me.width);
                        ...
                        switch (scaleLabelAlign) {
                            case 'start':
                                scaleLabelY =
                                    me.top + (isReverse ? 0 : me.height);
                                textAlign =
                                    isReverse === isLeft ? 'right' : 'left';
                                break;
                            case 'end':
                                scaleLabelY =
                                    me.top + (isReverse ? me.height : 0);
                                textAlign =
                                    isReverse === isLeft ? 'left' : 'right';
                                break;
                            default:
            ...
            },
            {
                ...
                value: function _resolveTickFontOptions(index) {
                    ...
                    return _extends(
                        ...
                        {
                            color: resolve(
                                [options.fontColor, defaults.fontColor],
                                context
                            ),
    ...
    var CategoryScale = (function (_Scale) {
        ...
        function CategoryScale(cfg) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(CategoryScale).call(this, cfg)
            );
            _this._numLabels = 0;
        ...
        _createClass(CategoryScale, [
            ...
            },
            {
                ...
                value: function configure() {
                    var me = this;
                    _get(
                        _getPrototypeOf(CategoryScale.prototype),
                        'configure',
                        this
                    ).call(this);
                    if (!me.isHorizontal()) {
            ...
            },
            {
                ...
                value: function getPixelForValue(value) {
                    ...
                    return me.getPixelForDecimal(
                        (value - me._startValue) / me._valueRange
                    );
                },
            },
            {
    ...
    function generateTicks(generationOptions, dataRange) {
        ...
        if (numSpaces > maxNumSpaces) {
            spacing =
                niceNum((numSpaces * spacing) / maxNumSpaces / unit) * unit;
        }
    ...
    var LinearScaleBase = (function (_Scale) {
        ...
        function LinearScaleBase(cfg) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(LinearScaleBase).call(this, cfg)
            );
        ...
        _createClass(LinearScaleBase, [
            ...
            },
            {
                ...
                value: function handleTickRangeOptions() {
                    ...
                    var setMin =
                        opts.min !== undefined ||
                        opts.suggestedMin !== undefined;
                    var setMax =
                        opts.max !== undefined ||
                        opts.suggestedMax !== undefined;
            ...
            },
            {
                ...
                value: function configure() {
                    ...
                    var end = me.max;
                    _get(
                        _getPrototypeOf(LinearScaleBase.prototype),
                        'configure',
                        this
                    ).call(this);
                    if (me.options.offset && ticks.length) {
                        var offset =
                            (end - start) / Math.max(ticks.length - 1, 1) / 2;
                        start -= offset;
                        end += offset;
                    }
            ...
            },
            {
                key: 'getLabelForValue',
                value: function getLabelForValue(value) {
                    return new Intl.NumberFormat(this.options.locale).format(
                        value
                    );
                },
            },
    ...
    var LinearScale = (function (_LinearScaleBase) {
        ...
        function LinearScale() {
            ...
            return _possibleConstructorReturn(
                this,
                _getPrototypeOf(LinearScale).apply(this, arguments)
            );
        }
    ...
    var LogarithmicScale = (function (_Scale) {
        ...
        function LogarithmicScale(cfg) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(LogarithmicScale).call(this, cfg)
            );
            _this.start = undefined;
            _this.end = undefined;
            _this._startValue = undefined;
        ...
        _createClass(LogarithmicScale, [
            ...
            },
            {
                ...
                value: function getLabelForValue(value) {
                    return value === undefined
                        ? '0'
                        : new Intl.NumberFormat(this.options.locale).format(
                              value
                          );
                },
            },
            ...
            },
            {
                ...
                value: function configure() {
                    ...
                    var start = me.min;
                    _get(
                        _getPrototypeOf(LogarithmicScale.prototype),
                        'configure',
                        this
                    ).call(this);
            ...
            },
            {
                ...
                value: function getValueForPixel(pixel) {
                    ...
                    return Math.pow(
                        10,
                        me._startValue + decimal * me._valueRange
                    );
                },
            },
        ]);
    ...
    function getTickBackdropHeight(opts) {
        ...
        if (tickOpts.display && opts.display) {
            return (
                valueOrDefault$2(tickOpts.fontSize, defaults.fontSize) +
    ...
    var RadialLinearScale = (function (_LinearScaleBase) {
        ...
        function RadialLinearScale(cfg) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(RadialLinearScale).call(this, cfg)
            );
        ...
        _createClass(RadialLinearScale, [
            ...
            },
            {
                ...
                value: function generateTickLabels(ticks) {
                    var me = this;
                    LinearScaleBase.prototype.generateTickLabels.call(
                        me,
                        ticks
                    );
            ...
            },
            {
                ...
                value: function getIndexAngle(index) {
                    var chart = this.chart;
                    var angleMultiplier =
                        (Math.PI * 2) / chart.data.labels.length;
                    var options = chart.options || {};
                    var startAngle = options.startAngle || 0;
                    return _normalizeAngle(
                        index * angleMultiplier + toRadians(startAngle)
                    );
                },
            },
            {
            ...
            },
            {
                ...
                value: function drawGrid() {
                    ...
                    var lineWidth = valueOrDefault$2(
                        angleLineOpts.lineWidth,
                        gridLineOpts.lineWidth
                    );
                    var lineColor = valueOrDefault$2(
                        angleLineOpts.color,
                        gridLineOpts.color
                    );
            ...
            },
            {
                ...
                value: function drawLabels() {
                    ...
                    var tickFontColor = valueOrDefault$2(
                        tickOpts.fontColor,
                        defaults.fontColor
                    );
                    var offset, width;
    ...
    function computeOffsets(table, timestamps, min, max, options) {
        ...
        if (options.offset && timestamps.length) {
            ...
            if (timestamps.length === 1) {
                ...
                start =
                    (interpolate(table, 'time', timestamps[1], 'pos') - first) /
                    2;
            }
            last = interpolate(
                table,
    ...
    var TimeScale = (function (_Scale) {
        ...
        function TimeScale(props) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(TimeScale).call(this, props)
            );
            var options = _this.options;
            var time = options.time || (options.time = {});
            var adapter = (_this._adapter = new _adapters._date(
        ...
        _createClass(TimeScale, [
            ...
            },
            {
                ...
                value: function buildTicks() {
                    ...
                    if (options.bounds === 'ticks' && timestamps.length) {
                        ...
                        me.max =
                            me._userMax || timestamps[timestamps.length - 1];
                    }
                    var min = me.min;
                    var max = me.max;
            ...
            },
            {
                ...
                value: function _tickFormatFunction(
                    time,
                    index,
                    ticks,
                    format
            ...
            },
            {
                ...
                value: function generateTickLabels(ticks) {
                    ...
                    for (i = 0, ilen = ticks.length; i < ilen; ++i) {
                        tick = ticks[i];
                        tick.label = this._tickFormatFunction(
                            tick.value,
                            i,
                            ticks
                        );
            ...
            },
            {
                ...
                value: function getValueForPixel(pixel) {
                    ...
                    var offsets = me._offsets;
                    var pos =
                        me.getDecimalForPixel(pixel) / offsets.factor -
                        offsets.end;
            ...
            },
            {
                ...
                value: function _getLabelCapacity(exampleTime) {
                    ...
                    var format =
                        displayFormats[timeOpts.unit] ||
                        displayFormats.millisecond;
                    var exampleLabel = me._tickFormatFunction(
                        exampleTime,
                        0,
    ...
    var Legend = (function (_Element) {
        ...
        function Legend(config) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(Legend).call(this)
            );
        ...
        _createClass(Legend, [
                    ...
                    if (isHorizontal) {
                        ...
                        me.legendItems.forEach(function (legendItem, i) {
                            ...
                            if (
                                ...
                                totalWidth +=
                                    currentColWidth + labelOpts.padding;
            ...
            },
            {
                ...
                value: function draw() {
                    ...
                    var boxWidth = getBoxWidth(labelOpts, fontSize);
                    var hitboxes = me.legendHitBoxes;
                    var drawLegendBox = function drawLegendBox(
                        x,
                        y,
                        legendItem
                    ) {
                    ...
                    var fillText = function fillText(
                        ...
                        if (legendItem.hidden) {
                            ...
                            ctx.lineTo(
                                rtlHelper.xPlus(xLeft, textWidth),
                                yMiddle
                            );
                            ctx.stroke();
                        }
                    };
                    var alignmentOffset = function alignmentOffset(
                        dimension,
                        blockSize
                    ) {
                        switch (opts.align) {
                    ...
                    me.legendItems.forEach(function (legendItem, i) {
                        ...
                        if (isHorizontal) {
                            ...
                            i > 0 &&
                            y + itemHeight > me.top + me._minSize.height
                        ) {
                            x = cursor.x =
                                x +
                ...
                value: function drawTitle() {
                    ...
                    if (this.isHorizontal()) {
                        maxWidth = Math.max.apply(
                            Math,
                            _toConsumableArray(me.lineWidths)
                        );
                        switch (opts.align) {
                            case 'start':
                                break;
                        ...
                        var maxHeight = Math.max.apply(
                            Math,
                            _toConsumableArray(me.columnHeights)
                        );
                        switch (opts.align) {
                            case 'start':
                                break;
    ...
    var Title = (function (_Element) {
        ...
        function Title(config) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(Title).call(this)
            );
            _extends(_assertThisInitialized(_this), config);
            _this.chart = config.chart;
            _this.options = config.options;
        ...
        _createClass(Title, [
            ...
            },
            {
                ...
                value: function fit() {
                    ...
                    var textSize =
                        lineCount *
                            helpers.options._parseFont(opts).lineHeight +
                        me._padding.height;
                ...
                value: function draw() {
                    ...
                    if (me.isHorizontal()) {
                        ...
                        switch (opts.align) {
                            case 'start':
                                titleY =
                                    opts.position === 'left' ? bottom : top;
                                align = 'left';
                                break;
                            case 'end':
                                titleY =
                                    opts.position === 'left' ? top : bottom;
                                align = 'right';
                                break;
                            default:
        ...
        nearest: function nearest(items, eventPosition) {
            ...
            for (i = 0, len = items.length; i < len; ++i) {
                ...
                if (el && el.hasValue()) {
                    ...
                    var d = helpers.math.distanceBetweenPoints(
                        eventPosition,
                        center
                    );
                    if (d < minDistance) {
    ...
    function createTooltipItem(chart, item) {
        var datasetIndex = item.datasetIndex,
            index = item.index;
        var _chart$getDatasetMeta = chart
    ...
    function resolveOptions(options) {
        ...
        options.bodyFontFamily = valueOrDefault$3(
            options.bodyFontFamily,
            defaults.fontFamily
        );
        options.bodyFontStyle = valueOrDefault$3(
            options.bodyFontStyle,
            defaults.fontStyle
        );
        options.bodyFontSize = valueOrDefault$3(
            options.bodyFontSize,
            defaults.fontSize
        );
        options.boxHeight = valueOrDefault$3(
            options.boxHeight,
            options.bodyFontSize
        );
        options.boxWidth = valueOrDefault$3(
            options.boxWidth,
            options.bodyFontSize
        );
        options.titleFontFamily = valueOrDefault$3(
            options.titleFontFamily,
            defaults.fontFamily
        );
        options.titleFontStyle = valueOrDefault$3(
            options.titleFontStyle,
            defaults.fontStyle
        );
        options.titleFontSize = valueOrDefault$3(
            options.titleFontSize,
            defaults.fontSize
        );
        options.footerFontFamily = valueOrDefault$3(
            options.footerFontFamily,
            defaults.fontFamily
        );
        options.footerFontStyle = valueOrDefault$3(
            options.footerFontStyle,
            defaults.fontStyle
        );
        options.footerFontSize = valueOrDefault$3(
    ...
    function getTooltipSize(tooltip) {
        ...
        if (titleLineCount) {
            height +=
                titleLineCount * titleFontSize +
                (titleLineCount - 1) * options.titleSpacing +
                options.titleMarginBottom;
        }
        if (combinedBodyLength) {
            var bodyLineHeight = options.displayColors
                ? Math.max(boxHeight, bodyFontSize)
                : bodyFontSize;
            height +=
    ...
    function determineAlignment(chart, options, size) {
        ...
        var olf = function olf(value) {
            return (
                value + width + options.caretSize + options.caretPadding >
                chart.width
            );
        };
    ...
    var Tooltip = (function (_Element) {
        ...
        function Tooltip(config) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(Tooltip).call(this)
            );
            _this.opacity = 0;
            _this._active = [];
        ...
        _createClass(Tooltip, [
            ...
            },
            {
                ...
                value: function getTitle(tooltipitem, data) {
                    ...
                    var afterTitle = callbacks.afterTitle.apply(me, [
                        tooltipitem,
                        data,
                    ]);
                    var lines = [];
            ...
            },
            {
                ...
                value: function getBeforeBody(tooltipitem, data) {
                    return getBeforeAfterBodyLines(
                        this.options.callbacks.beforeBody.apply(this, [
                            tooltipitem,
                            data,
                        ])
                    );
            ...
            },
            {
                ...
                value: function getAfterBody(tooltipitem, data) {
                    return getBeforeAfterBodyLines(
                        this.options.callbacks.afterBody.apply(this, [
                            tooltipitem,
                            data,
                        ])
                    );
            ...
            },
            {
                ...
                value: function getFooter(tooltipitem, data) {
                    var me = this;
                    var callbacks = me.options.callbacks;
                    var beforeFooter = callbacks.beforeFooter.apply(me, [
                        tooltipitem,
                        data,
                    ]);
                    ...
                    var afterFooter = callbacks.afterFooter.apply(me, [
                        tooltipitem,
                        data,
                    ]);
                    var lines = [];
            ...
            },
            {
                ...
                value: function _createItems() {
                    ...
                    for (i = 0, len = active.length; i < len; ++i) {
                        tooltipItems.push(
                            createTooltipItem(me._chart, active[i])
                        );
                    }
                    if (options.filter) {
                    ...
                    helpers.each(tooltipItems, function (tooltipItem) {
                        labelColors.push(
                            options.callbacks.labelColor.call(
                                me,
                                tooltipItem,
                                me._chart
                            )
                        ...
                        labelTextColors.push(
                            options.callbacks.labelTextColor.call(
                                me,
                                tooltipItem,
                                me._chart
                            )
            ...
            },
            {
                ...
                value: function update(changed) {
                    ...
                    if (!active.length) {
                        ...
                        var data = me._chart.data;
                        var position = positioners[options.position].call(
                            me,
                            active,
                            me._eventPosition
                        );
                        ...
                        var alignment = determineAlignment(
                            me._chart,
                            options,
                            positionAndSize
                        );
                        var backgroundPoint = getBackgroundPoint(
                            options,
                            positionAndSize,
                            alignment,
                            me._chart
                ...
                value: function drawTitle(pt, ctx) {
                    ...
                    if (length) {
                        ...
                        for (i = 0; i < length; ++i) {
                            ...
                            if (i + 1 === length) {
                                pt.y +=
                                    options.titleMarginBottom - titleSpacing;
                            }
                        }
                    }
                },
            },
            {
                ...
                value: function _drawColorBox(ctx, pt, i, rtlHelper) {
                    ...
                    var yOffSet =
                        boxHeight < bodyFontSize
                            ? (bodyFontSize - boxHeight) / 2
                            : 0;
            ...
            },
            {
                ...
                value: function drawBody(pt, ctx) {
                    ...
                    var bodyAlignForCalculation = rtlHelper.textAlign(
                        bodyAlign
                    );
            ...
            },
            {
                ...
                value: function draw(ctx) {
                    ...
                    if (options.enabled && hasTooltipContent) {
                        ...
                        helpers.rtl.overrideTextDirection(
                            ctx,
                        ...
                        helpers.rtl.restoreTextDirection(
                            ctx,
                            options.textDirection
                        );
                        ctx.restore();
            ...
            },
            {
                ...
                value: function handleEvent(e, replay) {
                    ...
                    changed =
                        replay || !helpers._elementsEqual(active, lastActive);
                    if (changed) {
                        me._active = active;
    ...
    var tooltip = {
        ...
        afterDraw: function afterDraw(chart) {
            ...
            if (
                pluginsCore.notify(chart, 'beforeTooltipDraw', [args]) === false
            ) {
                return;
            }

...
!(function (a) {
  'function' == typeof define && define.amd ? define(['jquery', 'jquery-ui-bundle'], a) : a(jQuery);
})(function ($) {
  if ((($.ui.timepicker = $.ui.timepicker || {}), !$.ui.timepicker.version)) {
    ...
    $.extend(Timepicker.prototype, {
      ...
      _newInst: function ($input, opts) {
        ...
        (tp_inst._defaults = $.extend({}, this._defaults, inlineSettings, opts, overrides, { evnts: fns, timepicker: tp_inst })),
          ...
          'string' == typeof tp_inst._defaults.controlType
            ? ('slider' === tp_inst._defaults.controlType && 'undefined' == typeof $.ui.slider && (tp_inst._defaults.controlType = 'select'), (tp_inst.control = tp_inst._controls[tp_inst._defaults.controlType]))
        ...
        return (
          ...
          (tp_inst.timezone = null !== tp_inst._defaults.timezone ? $.timepicker.timezoneOffsetNumber(tp_inst._defaults.timezone) : new Date().getTimezoneOffset() * -1),
        ...
        if (0 === a.find('div.ui-timepicker-div').length && b.showTimepicker) {
          ...
          for (j = 0, k = this.units.length; j < k; j++) {
            if (
              ...
              else for (var p = b[d + 'Min']; p <= g[d]; p += parseInt(b[d + 'Grid'], 10)) h[d]++, (m += '<td data-for="' + d + '">' + (p < 10 ? '0' : '') + p + '</td>');
              m += '</tr></table></div>';
            }
            m += '</dd>';
          }
          ...
          var r = $(m);
          for (
            b.timeOnly === !0 && (r.prepend('<div class="ui-widget-header ui-helper-clearfix ui-corner-all"><div class="ui-datepicker-title">' + b.timeOnlyTitle + '</div></div>'), a.find('.ui-datepicker-header, .ui-datepicker-calendar').hide()),
              j = 0,
              k = c.units.length;
            j < k;
            j++
                ...
                r
                  ...
                  .on('click', function (a) {
                    var b = $(this),
                      ...
                      g = e.replace(/[^apm]/gi),
                      h = b.data('for');
                    'hour' === h && (g.indexOf('p') !== -1 && f < 12 ? (f += 12) : g.indexOf('a') !== -1 && 12 === f && (f = 0)), c.control.value(c, c[h + '_slider'], d, f), c._onTimeChange(), c._onSelectHandler();
                  })
                  .css({
                    cursor: 'pointer',
                    width: 100 / h[d] + '%',
          ...
          if (
            ...
            var s = new Date(this.inst.selectedYear, this.inst.selectedMonth, this.inst.selectedDay, 12).getTimezoneOffset() * -1;
          ...
          if (
            ...
            this.$timeObj.change(function () {
              var a = c.inst.settings.timeFormat,
                ...
                d = new Date();
              b ? (d.setHours(b.hour), d.setMinutes(b.minute), d.setSeconds(b.second), $.datepicker._setTime(c.inst, d)) : ((this.value = c.formattedTime), this.on('blur'));
            }),
            null !== this.inst)
          ) {
      ...
      _limitMinMaxDateTime: function (a, b) {
        ...
        if (this._defaults.showTimepicker) {
          if (null !== $.datepicker._get(a, 'minDateTime') && void 0 !== $.datepicker._get(a, 'minDateTime') && d) {
            ...
            (null !== this.hourMinOriginal && null !== this.minuteMinOriginal && null !== this.secondMinOriginal && null !== this.millisecMinOriginal && null !== this.microsecMinOriginal) ||
                          ...
                          this.second <= this._defaults.secondMin
                            ? ((this.second = this._defaults.secondMin),
                              ...
                              this.millisec <= this._defaults.millisecMin
                                ? ((this.millisec = this._defaults.millisecMin), (this._defaults.microsecMin = e.getMicroseconds()))
                                : (this.microsec < this._defaults.microsecMin && (this.microsec = this._defaults.microsecMin), (this._defaults.microsecMin = this.microsecMinOriginal)))
          ...
          if (null !== $.datepicker._get(a, 'maxDateTime') && void 0 !== $.datepicker._get(a, 'maxDateTime') && d) {
            ...
            (null !== this.hourMaxOriginal && null !== this.minuteMaxOriginal && null !== this.secondMaxOriginal && null !== this.millisecMaxOriginal) ||
                          ...
                          this.second >= this._defaults.secondMax
                            ? ((this.second = this._defaults.secondMax),
                              ...
                              this.millisec >= this._defaults.millisecMax
                                ? ((this.millisec = this._defaults.millisecMax), (this._defaults.microsecMax = g.getMicroseconds()))
                                : (this.microsec > this._defaults.microsecMax && (this.microsec = this._defaults.microsecMax), (this._defaults.microsecMax = this.microsecMaxOriginal)))
          ...
          if (null !== a.settings.minTime) {
            ...
            this.hour < i.getHours()
              ? ((this.hour = this._defaults.hourMin = i.getHours()), (this.minute = this._defaults.minuteMin = i.getMinutes()))
              ...
              ? ((this._defaults.hourMin = i.getHours()), (this._defaults.minuteMin = i.getMinutes()))
              : (this._defaults.hourMin === i.getHours()) === this.hour && this._defaults.minuteMin < i.getMinutes()
          ...
          if (null !== a.settings.maxTime) {
            ...
            this.hour > j.getHours()
              ? ((this.hour = this._defaults.hourMax = j.getHours()), (this.minute = this._defaults.minuteMax = j.getMinutes()))
              ...
              ? ((this._defaults.hourMax = j.getHours()), (this._defaults.minuteMax = j.getMinutes()))
              : (this._defaults.hourMax === j.getHours()) === this.hour && this._defaults.minuteMax > j.getMinutes()
      ...
      _onTimeChange: function () {
        if (this._defaults.showTimepicker) {
          var a = !!this.hour_slider && this.control.value(this, this.hour_slider, 'hour'),
          ...
          var j = g[a < 12 ? 'amNames' : 'pmNames'][0],
            k =
              ...
              (this.ampm.length > 0 && a < 12 != ($.inArray(this.ampm.toUpperCase(), this.amNames) !== -1)) ||
          ...
          if (
            ...
            this.$timeObj && (h === g.timeFormat ? this.$timeObj.val(this.formattedTime + i) : this.$timeObj.val($.datepicker.formatTime(h, this, g) + i), this.$timeObj[0].setSelectionRange))
          ) {
      ...
      _updateDateTime: function (a) {
        ...
        if (
          ('' === a.lastVal && ((a.currentYear = a.selectedYear), (a.currentMonth = a.selectedMonth), (a.currentDay = a.selectedDay)),
          this._defaults.timeOnly === !0 && this._defaults.timeOnlyShowDate === !1
            ? (g = this.formattedTime)
            : ((this._defaults.timeOnly !== !0 && (this._defaults.alwaysSetTime || f)) || (this._defaults.timeOnly === !0 && this._defaults.timeOnlyShowDate === !0)) && (g += this._defaults.separator + this.formattedTime + this._defaults.timeSuffix),
          ...
          if (this.$altInput && this._defaults.timeOnly === !1 && this._defaults.altFieldTimeOnly === !0) this.$altInput.val(this.formattedTime), this.$input.val(this.formattedDate);
            ...
            this._defaults.timeOnly || ((h = this._defaults.altFormat ? $.datepicker.formatDate(this._defaults.altFormat, null === c ? new Date() : c, e) : this.formattedDate), h && (h += i)),
        ...
        slider: {
          ...
          options: function (a, b, c, d, e) {
            if (a._defaults.isRTL) {
              if ('string' == typeof d) return 'min' === d || 'max' === d ? (void 0 !== e ? b.slider(d, e * -1) : Math.abs(b.slider(d))) : b.slider(d);
              var f = d.min,
                g = d.max;
              return (d.min = d.max = null), void 0 !== f && (d.max = f * -1), void 0 !== g && (d.min = g * -1), b.slider(d);
            }
            return 'string' == typeof d && void 0 !== e ? b.slider(d, e) : b.slider(d);
          },
          value: function (a, b, c, d) {
            return a._defaults.isRTL ? (void 0 !== d ? b.slider('value', d * -1) : Math.abs(b.slider('value'))) : void 0 !== d ? b.slider('value', d) : b.slider('value');
          },
        },
        select: {
          create: function (a, b, c, d, e, f, g) {
            for (
              var h = '<select class="ui-timepicker-select ui-state-default ui-corner-all" data-unit="' + c + '" data-min="' + e + '" data-max="' + f + '" data-step="' + g + '">', i = a._defaults.pickerTimeFormat || a._defaults.timeFormat, j = e;
              j <= f;
              j += g
            )
              (h += '<option value="' + j + '"' + (j === d ? ' selected' : '') + '>'),
                (h += 'hour' === c ? $.datepicker.formatTime($.trim(i.replace(/[^ht ]/gi, '')), { hour: j }, a._defaults) : 'millisec' === c || 'microsec' === c || j >= 10 ? j : '0' + j.toString()),
                (h += '</option>');
            return (
              (h += '</select>'),
          ...
          f =
            ...
            function (a, b, c) {
                    ...
                    .replace(/([hH]{1,2}|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|'.*?')/g, function (a) {
                      ...
                      switch (a.charAt(0).toLowerCase()) {
                        ...
                        default:
                          return (
                            '(' +
                            a.replace(/\'/g, '').replace(/(\.|\$|\^|\\|\/|\(|\)|\[|\]|\?|\+|\*)/g, function (a) {
                              return '\\' + a;
                            }) +
                            ')?'
                          );
              ...
              return (
                ...
                g.h !== -1 && ('AM' === h && '12' === i[g.h] ? (j.hour = 0) : 'PM' === h && '12' !== i[g.h] ? (j.hour = parseInt(i[g.h], 10) + 12) : (j.hour = Number(i[g.h]))),
                g.m !== -1 && (j.minute = Number(i[g.m])),
                g.s !== -1 && (j.second = Number(i[g.s])),
                g.l !== -1 && (j.millisec = Number(i[g.l])),
                g.c !== -1 && (j.microsec = Number(i[g.c])),
                g.z !== -1 && void 0 !== i[g.z] && (j.timezone = $.timepicker.timezoneOffsetNumber(i[g.z])),
                j)
              );
            }),
          g = function (a, b, c) {
      ...
      ($.datepicker._selectDate = function (a, b) {
        ...
        d && c.settings.showTimepicker
          ? (d._limitMinMaxDateTime(c, !0), (e = c.inline), (c.inline = c.stay_open = !0), this._base_selectDate(a, b), (c.inline = e), (c.stay_open = !1), this._notifyChange(c), this._updateDatepicker(c))
        ...
        if (b) {
          ...
          if (c) {
            ...
            (g += $.datepicker.formatTime(j, b, b._defaults) + i),
              b._defaults.timeOnly || b._defaults.altFieldTimeOnly || null === e || (g = b._defaults.altFormat ? $.datepicker.formatDate(b._defaults.altFormat, e, f) + h + g : b.formattedDate + h + g),
              $(c).val(a.input.val() ? g : '');
          }
      ...
      ($.datepicker._setTimeDatepicker = function (a, b, c) {
        ...
        if (d) {
          ...
          if (e) {
            ...
            var f;
            b &&
              ('string' == typeof b ? (e._parseTime(b, c), (f = new Date()), f.setHours(e.hour, e.minute, e.second, e.millisec), f.setMicroseconds(e.microsec)) : ((f = new Date(b.getTime())), f.setMicroseconds(b.getMicroseconds())),
      ...
      ($.datepicker._setDateDatepicker = function (a, b) {
        ...
        if (c) {
          ...
          d instanceof Date ? ((f = new Date(d.getTime())), f.setMicroseconds(d.getMicroseconds())) : (f = d),
            e &&
              f &&
              (e.support.timezone || null !== e._defaults.timezone || (e.timezone = f.getTimezoneOffset() * -1),
              (d = $.timepicker.timezoneAdjust(d, $.timepicker.timezoneOffsetString(-d.getTimezoneOffset()), e.timezone)),
              (f = $.timepicker.timezoneAdjust(f, $.timepicker.timezoneOffsetString(-f.getTimezoneOffset()), e.timezone))),
        ...
        if (c) {
          ...
          if (d) {
            ...
            var e = this._getDate(c),
              f = null;
            return (
              (f = d.$altInput && d._defaults.altFieldTimeOnly ? d.$input.val() + ' ' + d.$altInput.val() : 'INPUT' !== d.$input.get(0).tagName && d.$altInput ? d.$altInput.val() : d.$input.val()),
              e &&
                d._parseTime(f, !c.settings.timeOnly) &&
                (e.setHours(d.hour, d.minute, d.second, d.millisec),
                e.setMicroseconds(d.microsec),
                null != d.timezone && (d.support.timezone || null !== d._defaults.timezone || (d.timezone = e.getTimezoneOffset() * -1), (e = $.timepicker.timezoneAdjust(e, d.timezone, $.timepicker.timezoneOffsetString(-e.getTimezoneOffset()))))),
              e
            );
          }
      ...
      ($.datepicker._optionDatepicker = function (a, b, c) {
        ...
        if (f) {
          ...
          if (
            (g
              ? ((g = 0 === g ? new Date() : new Date(g)), (f._defaults.minDate = g), (f._defaults.minDateTime = g))
              : h
              ? ((h = 0 === h ? new Date() : new Date(h)), (f._defaults.maxDate = h), (f._defaults.maxDateTime = h))
              : i && (f._defaults.onSelect = i),
            g || h)
          )
            return (o = $(a)), (n = o.datetimepicker('getDate')), (m = this._base_optionDatepicker.call($.datepicker, a, e || b, c)), o.datetimepicker('setDate', n), m;
        }
        ...
        function f(e, f) {
          ...
          if (null !== g) {
            ...
            j.setMilliseconds(j.getMilliseconds() + d.minInterval),
              ...
              d.minInterval > 0 && j > h ? c[a]('setDate', j) : d.maxInterval > 0 && k < h ? c[a]('setDate', k) : g > h && f[a]('setDate', i);
          }
        }
        function g(b, c, e) {
          if (b.val()) {

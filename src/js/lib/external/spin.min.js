...
!(function (t, e) {
  ...
  function o(t, e) {
    ...
    for (o = 0; o < d.length; o++) if (void 0 !== n[(i = d[o] + e)]) return i;
  }
  function n(t, e) {
    ...
    r(a.prototype, {
      spin: function (e) {
        ...
        if (
          ...
          !(function t() {
            a++;
            for (var e = 0; e < o.lines; e++) (s = Math.max(1 - ((a + (o.lines - e) * f) % p) * u, o.opacity)), i.opacity(r, e * o.direction + c, s, o);
      ...
      lines: function (o, r) {
        ...
        for (var c, d = 0, p = ((r.lines - 1) * (1 - r.direction)) / 2; d < r.lines; d++)
          (c = n(t(), {
            ...
            opacity: r.opacity,
            animation: l && i(r.opacity, r.trail, p + d * r.direction, r.lines) + ' ' + 1 / r.speed + 's linear infinite',
          })),
            r.shadow && e(c, n(a('#000', '0 0 4px #000'), { top: '2px' })),
            e(o, e(c, a(s(r.color, d), '0 0 1px rgba(0,0,0,.1)')));
        return o;
      },

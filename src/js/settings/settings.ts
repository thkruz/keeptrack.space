...
// Actual Setup
export let settingsManager: UserSettings = {
  classificationStr: '',
  ...
  init: (settingsOverride?: any) => {
    ...
    settingsManager.minZoomDistance = <Kilometers>(RADIUS_OF_EARTH + 50);
    settingsManager.maxZoomDistance = <Kilometers>120000;
    ...
    settingsManager.gpsElevationMask = <Degrees>15;

...
interface SatCacheObject extends satellite.SatRec {
  id?: number;
  isimp: boolean;
  apogee: number;
  isRadarData: any;
...
/** ARRAYS */
const satCache = <SatCacheObject[]>[]; // Cache of Satellite Data from TLE.json and Static Data from variable.js
...
let fieldOfViewSetLength: number;
let len;

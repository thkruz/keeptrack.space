...
export const Keys = [
  ...
  'errorMsgs.Collissions.noCollisionsData',
  'errorMsgs.Collissions.errorProcessingCollisions',
  ...
  'plugins.Collissions.bottomIconLabel',
  'plugins.Collissions.title',
  'plugins.Collissions.helpBody',

...
export const Keys = [
  ...
  'SatInfoBoxActions.title',
  'SatInfoBoxActions.tooltip',
  'SatInfoBoxActions.DrawLine.sunAngle',
  'SatInfoBoxActions.DrawLine.RicLine.label',
  'SatInfoBoxActions.DrawLine.RicLine.tooltip',
  'SatInfoBoxActions.DrawLine.nadirLine',
  'SatInfoBoxActions.DrawLine.secLine',
  'SatInfoBoxActions.SearchLinks.LaunchObjects.label',
  'SatInfoBoxActions.SearchLinks.LaunchObjects.tooltip',
  'SatInfoBoxActions.SearchLinks.nearOrbits.label',
  'SatInfoBoxActions.SearchLinks.nearOrbits.tooltip',
  'SatInfoBoxActions.SearchLinks.nearObjects1.label',
  'SatInfoBoxActions.SearchLinks.nearObjects1.tooltip',
  'SatInfoBoxActions.SearchLinks.nearObjects2.label',
  'SatInfoBoxActions.SearchLinks.nearObjects2.tooltip',
  'SatInfoBoxActions.SearchLinks.nearObjects4.label',
  'SatInfoBoxActions.SearchLinks.nearObjects4.tooltip',
  'SatInfoBoxActions.noSatelliteSelected',
  'SatInfoBoxActions.noSecondarySatelliteSelected',
  'SatInfoBoxLinks.title',
  'SatInfoBoxLinks.tooltip',
  'SatInfoBoxLinks.Celestrak.link',
  'SatInfoBoxLinks.Celestrak.title',
  'SatInfoBoxLinks.Kayhan.link',
  'SatInfoBoxLinks.N2YO.link',
  'SatInfoBoxLinks.N2YO.title',
  'SatInfoBoxLinks.Heavens_Above.link',
  'SatInfoBoxLinks.Heavens_Above.title',
  'SatInfoBoxLinks.notASatellite',
  'SatInfoBoxMission.title',
  'SatInfoBoxMission.Mission.label',
  'SatInfoBoxMission.Mission.tooltip',
  'SatInfoBoxMission.User.label',
  'SatInfoBoxMission.User.tooltip',
  'SatInfoBoxMission.Purpose.label',
  'SatInfoBoxMission.Purpose.tooltip',
  'SatInfoBoxMission.Contractor.label',
  'SatInfoBoxMission.Contractor.tooltip',
  'SatInfoBoxMission.LiftMass.label',
  'SatInfoBoxMission.LiftMass.tooltip',
  'SatInfoBoxMission.DryMass.label',
  'SatInfoBoxMission.DryMass.tooltip',
  'SatInfoBoxMission.LifeExpectancy.label',
  'SatInfoBoxMission.LifeExpectancy.tooltip',
  'SatInfoBoxMission.Bus.label',
  'SatInfoBoxMission.Bus.tooltip',
  'SatInfoBoxMission.Payload.label',
  'SatInfoBoxMission.Payload.tooltip',
  'SatInfoBoxMission.Equipment.label',
  'SatInfoBoxMission.Equipment.tooltip',
  'SatInfoBoxMission.Motor.label',
  'SatInfoBoxMission.Motor.tooltip',
  'SatInfoBoxMission.Length.label',
  'SatInfoBoxMission.Length.tooltip',
  'SatInfoBoxMission.Diameter.label',
  'SatInfoBoxMission.Diameter.tooltip',
  'SatInfoBoxMission.Span.label',
  'SatInfoBoxMission.Span.tooltip',
  'SatInfoBoxMission.Shape.label',
  'SatInfoBoxMission.Shape.tooltip',
  'SatInfoBoxMission.Power.label',
  'SatInfoBoxMission.Power.tooltip',
  'SatInfoBoxMission.missingElements',
  'SatInfoBoxMission.kg',
  'SatInfoBoxMission.m',
  'SatInfoBoxMission.w',
  'SatInfoBoxMission.yrs',
  'SatInfoBoxMission.unknown',
  'SatInfoBoxMission.noData',
] as const;

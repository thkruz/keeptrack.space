  ...
  $.get(simFile, function (missileArray) {
    ...
    for (var i = 0; i < missileArray.length; i++) {
      ...
      if (MissileObject) {
        ...
        updateOrbitBuffer(MissileObject.id, null, null, null, true, MissileObject.latList, MissileObject.lonList, MissileObject.altList, MissileObject.startTime);
      }
    }
    missileManager.missileArray = missileArray;
  }).done(() => {
...
missileManager.Missile = function (CurrentLatitude, CurrentLongitude, TargetLatitude, TargetLongitude, NumberWarheads, MissileObjectNum, CurrentTime, MissileDesc, Length, Diameter, NewBurnRate, MaxMissileRange, country, minAltitude) {
  ...
  //   var Alpha1 = calculatedCoordinates[2];
...
var _ThrustFun = (MassOut, Altitude, FuelArea, NozzleAltitude) => {
...
var _CoordinateCalculator = (CurrentLatitude, CurrentLongitude, TargetLatitude, TargetLongitude) => {
...
var _IterationFun = (FuelArea, FuelMass, RocketArea, Altitude, RocketCasingMass, NozzleAltitude, drdt, dthetadt, Distance, ArcDistance, MassIn, AngleCoefficient) => {
...
var _Bisection = (FuelArea1, FuelArea2, FuelMass, FuelVolume, RocketArea, Altitude, RocketCasingMass1, RocketCasingMass2, RocketCasingMass3, NozzleAltitude1, drdt, dthetadt, Distance, ArcDistance, MassIn, ArcLength, GoalDistance) => {
...
var _QuickRun = (FuelArea1, FuelArea2, FuelMass, FuelVolume, RocketArea, Altitude, RocketCasingMass1, RocketCasingMass2, RocketCasingMass3, NozzleAltitude1, drdt, dthetadt, Distance, ArcDistance, MassIn, AngleCoefficient) => {

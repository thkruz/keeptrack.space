...
$(document).ready(function () {
    ...
    function updateSelectedObjectInfo() {
        ...
        for (i = 0; i < jsTLEfile.length; i++) {
            ...
            if (
                SCC === $('#editor-scc').val() ||
                parseInt(SCC).toString() === $('#editor-scc').val()
            ) {
                ...
                $('#editor-constellation').val(
                    jsTLEfile[i].constellation || 'NSTR'
                );
        ...
        for (i = 0; i < satInfoList.length; i++) {
            if (
                satInfoList[i].SCC === $('#editor-scc').val() ||
                parseInt(satInfoList[i].SCC).toString() ===
                    $('#editor-scc').val()
            ) {
                ...
                $('#editor-constellation').val(
                    satInfoList[i].constellation || 'NSTR'
                );
                $('#editor-associates').val(
                    satInfoList[i].associates || 'NSTR'
                );
    ...
    $('#editor-file').change(function (evt) {
        ...
        reader.onload = function (evt) {
            ...
            for (var i = 0; i < array.length / 2; i++) {
                ...
                var SCC = _pad0(
                    parseInt(satellite.TLE1.substr(2, 5).trim()).toString(),
                    5
                );
                satellite.SCC = SCC;

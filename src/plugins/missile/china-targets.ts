...
export const CHINA_MILITARY_BASES: readonly GeoTarget[] = [
  ...
  { name: 'PLARF Base 61 (Huangshan)', lat: 30.4, lon: 118.37 },
  ...
  { name: 'PLARF Base 65 (Shenyang)', lat: 41.8, lon: 123.43 },
  ...
  { name: 'Zhanjiang Naval Base', lat: 21.2, lon: 110.4 },

  // PLA Air Force airfields
  { name: 'Anshan Air Base', lat: 41.1, lon: 122.85 },
  { name: 'Dingxin Test & Training Base', lat: 40.0, lon: 99.8 },
  { name: 'Golmud Air Base', lat: 36.4, lon: 94.79 },
  { name: 'Wenjiang Air Base (Chengdu)', lat: 30.7, lon: 103.83 },
  ...
  { name: 'Lop Nur Nuclear Test Base', lat: 41.5, lon: 88.3 },
...
export const CHINA_LARGEST_CITIES: readonly GeoTarget[] = [
  ...
  { name: 'Wuhan', lat: 30.59, lon: 114.3 },
  ...
  { name: 'Suzhou', lat: 31.3, lon: 120.58 },
  ...
  { name: 'Fuzhou', lat: 26.07, lon: 119.3 },
  ...
  { name: 'Wenzhou', lat: 27.99, lon: 120.7 },

...
export class PerformanceMenuPlugin extends KeepTrackPlugin {
        ...
        <form id="performance-form">
          ...
          <div class="row">
            <div class="input-field col s12">
              <input value="500" id="performance-maxMissiles" type="number" step="100" min="100" max="5000" data-position="top" data-delay="50"
              data-tooltip="Maximum number of missiles to render" />
              <label for="performance-maxMissiles" class="active">Max Missiles</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12">
              <input value="1" id="performance-maxFieldOfViewMarkers" type="number" step="1" min="1" max="100" data-position="top" data-delay="50"
              data-tooltip="Maximum field of view markers" />
              <label for="performance-maxFieldOfViewMarkers" class="active">Max FOV Markers</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12">
              <input value="10000" id="performance-maxAnalystSats" type="number" step="1000" min="1000" max="100000" data-position="top" data-delay="50"
              data-tooltip="Max analyst satellites (breakup scenarios)" />
              <label for="performance-maxAnalystSats" class="active">Max Analyst Satellites</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12">
              <input value="10" id="performance-maxOemSatellites" type="number" step="1" min="1" max="100" data-position="top" data-delay="50"
              data-tooltip="Maximum OEM satellites to load" />
              <label for="performance-maxOemSatellites" class="active">Max OEM Satellites</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12">
              <input value="100000" id="performance-maxNotionalDebris" type="number" step="10000" min="10000" max="500000" data-position="top"
              data-delay="50" data-tooltip="Maximum notional debris objects" />
          ...
          <div class="row">
            <div class="input-field col s12">
              <input value="0" id="performance-minimumDrawDt" type="number" step="5" min="0" max="100" data-position="top" data-delay="50"
              data-tooltip="Minimum time between draw calls (ms). 0=unlimited, 16.67=60fps, 33.33=30fps" />
              <label for="performance-minimumDrawDt" class="active">Min Draw Delta Time (ms)</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12">
              <input value="0" id="performance-fpsThrottle1" type="number" step="5" min="0" max="60" data-position="top" data-delay="50"
              data-tooltip="Min FPS or sun/moon are skipped" />
              <label for="performance-fpsThrottle1" class="active">FPS Throttle 1 (Sun/Moon)</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12">
              <input value="10" id="performance-fpsThrottle2" type="number" step="5" min="0" max="60" data-position="top" data-delay="50"
              data-tooltip="Min FPS or satellite velocities are ignored" />
  ...
  static resetToDefaults() {
    ...
    settingsManager.minimumDrawDt = 0 as Milliseconds;
  ...
  private static onSubmit_(e: SubmitEvent) {
    ...
    if (!isNaN(minimumDrawDt) && minimumDrawDt >= 0 && minimumDrawDt <= 100) {
      settingsManager.minimumDrawDt = minimumDrawDt as Milliseconds;
    }

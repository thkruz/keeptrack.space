...
describe('FormatTle_class', () => {
  ...
  it('test_inclination_invalid_length', () => {
    expect(() => {
      FormatTle.inclination('123456789' as any);
  ...
  it('test_mean_anomaly_invalid_length', () => {
    expect(() => {
      FormatTle.meanAnomaly('123456789' as any);
  ...
  it('test_mean_motion_invalid_length', () => {
    expect(() => {
      FormatTle.meanMotion('123456789012' as any);
  ...
  it('test_right_ascension_invalid_length', () => {
    expect(() => {
      FormatTle.rightAscension('123456789' as any);
  ...
  it('test_argument_of_perigee_invalid_length', () => {
    expect(() => {
      FormatTle.argumentOfPerigee('123456789' as any);

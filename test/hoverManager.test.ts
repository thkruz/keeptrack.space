...
describe('code_snippet', () => {
  ...
  beforeAll(() => {
    orbitManagerInstance = keepTrackContainer.get<OrbitManager>(Singletons.OrbitManager);
    catalogManagerInstance = keepTrackContainer.get<CatalogManager>(Singletons.CatalogManager);

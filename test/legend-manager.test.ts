...
import { settingsManager } from '../src/js/settings/settings';
import { LegendManager } from '../src/js/static/legend-manager';
import { defaultDiv, defaultSensorDiv, rcsDiv } from '../src/js/static/legend-manager/legend-divs';

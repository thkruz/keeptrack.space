import { triggerSubmit } from './../src/js/lib/trigger-submit';
...
Objective:
The objective of the triggerSubmit function is to dispatch a custom event named 'customSubmit' on the provided HTMLFormElement. This function is typically used to trigger a form submission programmatically.
